...
CONTROLS = [
    ...
    ("2.8",  "2.8-encryption.md",                              2, "manual",  [], "Does a current manual evidence pack document negotiated TLS handshakes, applicable connector controls, and (where deployed) Customer Key and Key Vault or Managed HSM configuration for Copilot-processed data?"),
