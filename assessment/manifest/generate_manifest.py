...
CONTROLS = [
    ...
    ("1.9",  "1.9-license-planning.md",                        1, "partial", ["M365Admin"], "Are Copilot license assignments reviewed against the entitlement plan and cost-allocation policies on a documented cadence?"),
    ...
    ("2.6",  "2.6-web-search-controls.md",                     2, "partial", ["M365Admin"], "Is Copilot web search configured per the organization's risk appetite and reviewed on a documented cadence?"),
    ("2.7",  "2.7-data-residency.md",                          2, "partial", ["M365Admin", "Graph_API"], "Are Microsoft 365 Copilot data residency settings configured and verified against regulatory requirements?"),
    ...
    ("4.2",  "4.2-teams-meetings-governance.md",               4, "partial", ["Teams"], "Are Copilot meeting recording and transcript controls configured per the organization's Teams meetings governance policy?"),
    ("4.3",  "4.3-teams-phone-queues.md",                      4, "partial", ["Teams"], "Are Copilot controls for Teams Phone queues configured per the organization's voice governance policy?"),
