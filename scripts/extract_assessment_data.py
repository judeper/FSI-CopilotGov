...
ROLE_CONTROLS = {
    ...
    "Purview Compliance Admin": ["1.5", "2.1", "2.2", "2.5", "2.10", "3.1", "3.2", "3.3", "3.4", "3.5", "3.6", "3.7", "3.8", "3.8a", "3.9", "3.10", "3.11", "3.12", "4.15", "4.16"],
    ...
    "AI Governance Lead": ["1.4", "1.10", "1.13", "1.16", "3.8a", "3.13", "4.6", "4.13", "4.15", "4.16"],
}
