...
ROLE_CONTROLS = {
    "M365 Global Admin": ["1.9", "1.11", "1.12", "2.17", "4.1", "4.2", "4.3", "4.4", "4.5", "4.7", "4.8", "4.12", "4.14", "4.15", "4.16"],
    "Purview Compliance Admin": ["1.5", "2.1", "2.2", "2.5", "2.10", "3.1", "3.2", "3.3", "3.4", "3.5", "3.6", "3.7", "3.8", "3.8a", "3.9", "3.10", "3.11", "3.12", "3.14", "4.15", "4.16"],
    ...
    "AI Governance Lead": ["1.4", "1.10", "1.13", "1.16", "2.17", "3.8a", "3.13", "4.6", "4.13", "4.14", "4.15", "4.16"],
}
