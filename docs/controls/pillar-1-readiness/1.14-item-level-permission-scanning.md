...
1. **Prerequisite — Site-Level Baseline:** Run DSPM oversharing assessment (Control 1.2) and SAM Data Access Governance snapshot and activity reports (Control 1.7) first. Item-level scanning is most effective after site-level oversharing has been remediated.
