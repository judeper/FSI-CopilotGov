...
**Regulatory Reference:** GLBA §501(b), FFIEC IT Handbook (IT Operations), Sarbanes-Oxley §§302/404 (where applicable to ICFR)
...
| **Microsoft 365 Copilot (Basic) / Copilot Chat (Basic)** | Included experience for users without a Microsoft 365 Copilot Premium add-on. Public Microsoft Learn documentation describes standalone Copilot Chat and standard in-app Copilot access; tenant-visible Message Center posts MC1253858/MC1253863 should be checked for any tenant-specific April 15, 2026 change to unlicensed in-app access | Included with eligible M365 licenses | Copilot Chat via web and Outlook; standard in-app Copilot access in Word, Excel, PowerPoint, and OneNote is subject to service capacity and the current tenant Message Center guidance |
...
### Copilot Basic vs. Premium Licensing Impact

!!! warning "Tenant-Verified In-App Copilot Licensing Change"
    Public Microsoft Learn documentation confirms the Copilot Chat Basic, Microsoft 365 Copilot Basic, and Microsoft 365 Copilot Premium experiences, including standard in-app Copilot access for Basic users in Word, Excel, PowerPoint, and OneNote. The April 15, 2026 effective date, more-than-2,000-seat threshold, and exact affected-app scope are Message Center details rather than publicly citable Learn facts. Verify the current tenant-visible text of MC1253858 and MC1253863 in **Microsoft 365 admin center > Health > Message center** before treating those figures as examination evidence. Tenant reports reviewed for this control state that unlicensed users in organizations with more than 2,000 Microsoft 365 seats lose the in-app Copilot experience in Word, Excel, PowerPoint, and OneNote, that organizations at or below that threshold retain throttled in-app access, and that Copilot in Outlook, standalone Copilot Chat, and agent experiences remain unchanged.

The Basic and Premium Copilot experiences create a licensing model that directly affects license planning:
...
- **Basic (included):** Copilot Chat via web and Outlook remains available for eligible users. Microsoft Learn describes Microsoft 365 Copilot (Basic) standard in-app access for users without the Premium add-on; verify any tenant-specific April 15, 2026 change, more-than-2,000-seat threshold, throttling language, and affected app list against MC1253858/MC1253863 in your tenant's Message Center before using those details in compliance evidence.

**License planning implications for FSI:**

- Organizations should inventory which user populations require in-app Copilot (Word, Excel, PowerPoint, and OneNote) versus Copilot Chat only.
- Budget planning should account for any tenant-confirmed loss of the in-app Copilot experience in Word, Excel, PowerPoint, and OneNote for unlicensed users in larger organizations.
...
- Organizations should verify that their current Copilot license allocation strategy accounts for the current Message Center guidance well before the tenant's stated effective date, and retain a screenshot or Graph `serviceAnnouncement/messages` export of MC1253858/MC1253863 with the published/updated timestamps.
...
- Organizations should review whether the Edit with Copilot toggle should be restricted for regulated user populations. See [Copilot Admin Toggles](../../reference/copilot-admin-toggles.md) for configuration guidance.
...
| **Copilot Cowork (GA June 2026)** | Microsoft 365 Copilot + usage-based billing (Copilot Credits) | Access is gated by usage-based billing on Copilot Credits; discovery is a separate setting. See [Control 4.15](../pillar-4-operations/4.15-copilot-cowork-governance.md). |
| **Microsoft Scout (Frontier preview)** | **Not part of the standard Microsoft 365 Copilot license.** Requires Frontier enrollment + Intune (or equivalent MDM) endpoint policy + admin attestation, and a per-user **GitHub Copilot Business or Enterprise** entitlement on a linked GitHub account. | The GitHub Copilot entitlement is owned outside the Microsoft 365 licensing surface; include the linked-GitHub-account reconciliation in the license inventory. See [Control 4.16](../pillar-4-operations/4.16-microsoft-scout-governance.md). |
...
- [Microsoft Learn: Microsoft 365 Copilot requirements](https://learn.microsoft.com/en-us/microsoft-365/copilot/microsoft-365-copilot-requirements)
...
- [Microsoft Learn: Microsoft 365 Copilot pay-as-you-go overview](https://learn.microsoft.com/en-us/microsoft-365/copilot/pay-as-you-go/overview)
...
- [Microsoft Learn: Group-based licensing in Microsoft Entra ID](https://learn.microsoft.com/en-us/entra/fundamentals/licensing)
...
- **Playbooks:** [Portal Walkthrough](../../playbooks/control-implementations/1.9/portal-walkthrough.md), [PowerShell Setup](../../playbooks/control-implementations/1.9/powershell-setup.md), [Verification & Testing](../../playbooks/control-implementations/1.9/verification-testing.md), [Troubleshooting](../../playbooks/control-implementations/1.9/troubleshooting.md)
