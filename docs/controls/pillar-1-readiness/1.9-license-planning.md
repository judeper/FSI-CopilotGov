...
- Organizations should assess whether third-party model usage aligns with their AI model risk management framework, particularly for OCC 2011-12 / SR 11-7 alignment (Control 3.8).
