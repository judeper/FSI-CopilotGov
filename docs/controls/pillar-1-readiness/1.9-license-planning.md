...
| **Microsoft 365 Copilot Chat (Basic)** | Free Copilot Chat tier available to all M365 users via web (copilot.microsoft.com) and inside Outlook; the separate in-app Copilot experience in Word, Excel, PowerPoint, and OneNote is limited for organizations with more than 2,000 seats after April 15, 2026 | Included with M365 | Web and Outlook Copilot Chat; limited in-app Copilot in Word, Excel, PowerPoint, and OneNote for larger organizations after April 15, 2026 |
...
!!! warning "In-App Copilot Licensing Change — April 15, 2026"
    Starting April 15, 2026, users without a paid Microsoft 365 Copilot license in organizations with more than 2,000 Microsoft 365 seats lose the in-app Copilot experience in Word, Excel, PowerPoint, and OneNote. Organizations at or below that seat threshold retain a throttled in-app Copilot experience in those apps. Copilot in Outlook, the standalone Copilot Chat experience (copilot.microsoft.com and in Outlook), and agent experiences remain unchanged.
...
- **Basic (free):** Copilot Chat via web and Outlook remains available and is not affected by the April 15, 2026 change. For organizations with more than 2,000 seats, the in-app Copilot experience in Word, Excel, PowerPoint, and OneNote is removed for unlicensed users after that date. Organizations at or below the seat threshold retain that in-app experience but may see throttling.
...
- Budget planning should account for the loss of the in-app Copilot experience in Word, Excel, PowerPoint, and OneNote for unlicensed users in larger organizations.
