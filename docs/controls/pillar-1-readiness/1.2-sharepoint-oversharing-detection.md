...
| **AI interaction evidence and separate Shadow AI discovery** | **DSPM > AI observability** and Activity explorer provide AI activity and interaction evidence; they do not by themselves establish Shadow AI app discovery. Use Microsoft Defender for Cloud Apps Cloud Discovery and the Generative AI cloud app catalog to discover, risk-assess, and sanction or unsanction third-party AI apps. For browser-visit signals in Purview, use an Insider Risk Management policy with the Microsoft Purview browser extension; device onboarding is required for sensitive-data visibility and endpoint DLP on third-party AI sites. | Continuous |
...
|-------|-------------|-----------|
| **Baseline** | Enable the unified DSPM experience. Review the default data risk assessment. Review and triage top 20 highest-risk sites. Remediate sites with "Everyone" or anonymous access containing sensitive information types. Establish monthly custom assessment cadence. Use Microsoft Defender for Cloud Apps Cloud Discovery and the Generative AI cloud app catalog for Shadow AI app discovery; retain DSPM AI observability as interaction evidence rather than a discovery substitute. | Addresses the most critical oversharing risks that could result in immediate regulatory exposure when Copilot is enabled. Visibility into unsanctioned AI apps is minimum viable governance for Copilot rollouts. |
| **Recommended** | All Baseline requirements plus: remediate top 50 oversharing sites. Establish weekly review of DSPM data risk assessment results. Configure AI observability for continuous monitoring across Copilot and third-party AI interactions, with auditing, device onboarding, browser configuration, and browser-extension prerequisites applied where the selected signal requires them. Deploy the Data Security Posture Agent for exploratory data risk investigation. Implement automated alerts for new oversharing detections. Document remediation actions and outcomes. | Provides ongoing oversharing governance with AI-specific visibility. The Data Security Posture Agent lets compliance teams investigate data risks without requiring pre-defined SITs. |
...
### Step 3: Review AI Interaction Evidence and Separately Discover Shadow AI

1. Open **DSPM** > **AI observability** and **Discover** > **Activity explorer** > **AI activities** to review AI apps, agents, and interaction evidence. Do not use this review alone as proof of Shadow AI app discovery.
2. For Microsoft 365 Copilot and agents, confirm Microsoft Purview auditing is enabled before relying on interaction evidence. For third-party generative AI site signals, use the [current DSPM overview](https://learn.microsoft.com/en-us/purview/data-security-posture-management-learn-about) as the primary reference and treat Microsoft's [DSPM for AI prerequisites (classic; superseded)](https://learn.microsoft.com/en-us/purview/dspm-for-ai-considerations) page as a legacy prerequisite reference only: device onboarding for sensitive-data visibility and endpoint DLP, an Edge configuration policy for Browser Data Security, and the Microsoft Purview browser extension on Windows users for an Insider Risk Management policy that detects site visits.
3. Use [Microsoft Defender for Cloud Apps discovery guidance](https://learn.microsoft.com/en-us/purview/deploymentmodels/depmod-data-leak-shadow-ai-step1) to discover and monitor third-party AI app use. In the Defender portal, use **Cloud Apps** > **Cloud app catalog**, filter **App category** to **Generative AI**, review risk and usage details, and tag apps as **Sanctioned** or **Unsanctioned** under the organization's governance process.
4. Route Defender discovery findings and DSPM interaction evidence to the governance team with their source and prerequisites recorded. Microsoft describes DSPM for AI as a source of interaction and sensitive-data insights, not the substitute for Defender for Cloud Apps app discovery.
...
7. AI observability and Activity explorer are configured for the selected interaction signals, with their auditing, device, browser, and collection-policy prerequisites documented
8. Microsoft Defender for Cloud Apps discovery findings for Generative AI apps are reviewed by the governance team to identify and classify unsanctioned AI tools
...
12. Automated alerts are configured for new oversharing detections, and Defender for Cloud Apps discovery findings are routed to the governance review process (Recommended and Regulated levels)
...
- [Microsoft Learn: DSPM for AI overview (classic; superseded)](https://learn.microsoft.com/en-us/purview/dspm-for-ai)
