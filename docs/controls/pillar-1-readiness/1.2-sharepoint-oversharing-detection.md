...
The unified DSPM experience (preview December 2025) merges the classic DSPM and DSPM for AI into a single platform, adding AI observability, item-level remediation, and the Purview Posture Agent across the full range of M365 and Copilot workloads. DSPM is accessible from both **Microsoft Purview > Data Security Posture Management** and the **Microsoft 365 Admin Center > Copilot > Overview > Security tab** for quick access to Copilot-specific security controls.
