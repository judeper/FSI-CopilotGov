...
|----------------|----------------------|-----|
| **BizChat (M365 Chat)** | Critical | Cross-workload search surfaces all overshared content |
...
Navigate to **Microsoft Purview compliance portal > DSPM for AI** and ensure the feature is activated for your tenant.
...
1. DSPM for AI is activated and accessible in the Microsoft Purview compliance portal
