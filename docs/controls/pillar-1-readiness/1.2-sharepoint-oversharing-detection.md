...
As of May 2026, the unified **DSPM** experience is generally available and replaces the prior "DSPM (preview)" naming. It merges the previous DSPM and DSPM for AI surfaces into a single platform, adding AI observability, item-level remediation, and the Purview Posture Agent across the full range of M365 and Copilot workloads. The earlier AI-specific surface continues to be available as **DSPM for AI (classic)** for organizations that have not yet migrated. Both views are accessible from **Microsoft Purview > Data Security Posture Management**. Where Microsoft 365 admin-center shortcuts are available, treat them as convenience entry points and verify the current path against the Purview experience before documenting operational procedures.
...
| **Asset Explorer** | Provides a unified inventory of data assets (files, sites, libraries) with their sensitivity classification, permission posture, and Copilot exposure status. Enables drill-down from aggregate risk metrics to individual assets for targeted remediation. | Continuous |
...
| **Partner Data-Source Readiness** | Assessment of third-party data sources (Graph connectors, federated connectors) for DSPM coverage readiness — identifies external data flows that enter the Copilot grounding scope but are not yet covered by DSPM policies | On-demand |
...
- [Microsoft Learn: Get started with DSPM for AI (classic)](https://learn.microsoft.com/en-us/purview/dspm-for-ai-considerations)
- [Microsoft Learn: Oversharing assessment in DSPM for AI (classic)](https://learn.microsoft.com/en-us/purview/ai-microsoft-purview)
