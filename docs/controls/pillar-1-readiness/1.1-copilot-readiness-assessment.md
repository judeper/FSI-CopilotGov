...
|------|---------|-------------|
| **Microsoft Purview DSPM for AI** | AI-specific readiness reports, oversharing detection, sensitivity label coverage analysis | Microsoft Purview portal > DSPM for AI |
...
Navigate to **Microsoft Purview portal > DSPM for AI > Overview** to access readiness dashboards and AI-specific reports.
