...
| **SharePoint Advanced Management (SAM)** | Data Access Governance (DAG) reports, site access reviews, sharing analytics | SharePoint admin center > Reports > Data access governance |
| **Microsoft Purview Data Map** | Automated data discovery and classification scanning across M365 workloads | Microsoft Purview > Data Map |
...
Navigate to **SharePoint admin center > Reports > Data access governance** and generate reports for:
