...
|----------------|----------------------|-------|
| **BizChat (M365 Chat)** | Critical | Primary surface where Graph connector data, plugins, and agents are invoked |
...
- [Microsoft Learn: Copilot plugins overview](https://learn.microsoft.com/en-us/copilot/microsoft-365/extensibility/overview-plugins)
- [Microsoft Learn: Declarative agents overview](https://learn.microsoft.com/en-us/copilot/microsoft-365/extensibility/overview-declarative-agent)
- [Microsoft Learn: Manage plugins for Copilot](https://learn.microsoft.com/en-us/copilot/microsoft-365/manage-plugins-for-copilot-in-integrated-apps)
...
- **Related Controls:** [1.10 Vendor Risk Management](1.10-vendor-risk-management.md), [1.1 Copilot Readiness Assessment](1.1-copilot-readiness-assessment.md), [1.4 Semantic Index Governance](1.4-semantic-index-governance.md), Pillar 2 Security Controls
