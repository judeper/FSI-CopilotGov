...
| **National cloud support** | Does the target cloud (GCC, GCC High, DoD) support the intended authoring tool? | Declarative agent support varies by government cloud — for example, Agent Builder is not available for declarative agents in DoD |
