...
|----------------|------------------------|-------------------|
| **BizChat (M365 Chat)** | Primary entry point for most users | How to query effectively, what data BizChat accesses, prompt best practices |
...
- [Microsoft Learn: Microsoft 365 Copilot Adoption](https://learn.microsoft.com/en-us/copilot/microsoft-365/microsoft-365-copilot-adoption)
...
- **Related Controls:** [1.12 Training and Awareness](1.12-training-awareness.md), [1.9 License Planning](1.9-license-planning.md), Pillar 4 Operations Controls
