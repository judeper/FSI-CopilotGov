...
**Regulatory Reference:** FFIEC IT Handbook (Management), 12 CFR part 30, appendix D (OCC Heightened Standards)
...
- **AI governance source monitoring:** Firms should define the primary sources, internal policies, and supervisory expectations they use for AI adoption governance. Change management builds the organizational infrastructure for responsible AI use where approved.
...
- **FINRA Rule 3110 (supervisory systems and WSPs):** Supervisory obligations extend to ensuring supervised persons understand how Copilot-generated content fits within compliance requirements. Change management programs help build this understanding.
...
The Microsoft 365 Copilot app displays an **organizational branded footer** on the Chat screen. The footer surfaces the organization logo that administrators already manage in Microsoft 365 admin center theming settings, paired with the fixed label **"Approved by"**. It is a co-branding visual identifier rather than a free-text field -- administrators cannot author custom footer wording such as a governance notice.
...
The logo shown in the footer is configured through organization theming in **M365 Admin Center > Settings > Org settings > Organization profile > Custom themes**. The branded footer reached general availability in July 2026 and rolls out progressively, so organizations should confirm availability in their own tenant.

Because the footer label is fixed, institutions that need explicit governance wording delivered in-product should use **Organizational messages** in the M365 Admin Center instead. Organizational messages support fully custom message content, logo and URL branding, Microsoft Entra group targeting, scheduling and frequency control, an approval workflow for custom messages, and delivery reporting. Organizations should verify that the footer logo and any accompanying organizational message align with their compliance communication standards before deployment.
...
| **Copilot Notebooks** | Collaborative AI content | Sharing governance, content ownership |
...
- **Microsoft 365 Admin Center > Reports > Usage > Microsoft 365 Copilot** for the **Readiness** and **Usage** reports (requires the AI Administrator role); Copilot activity for a given day typically appears within 48 hours
- **Microsoft Copilot Dashboard** in Copilot Analytics, powered by Viva Insights, for detailed adoption and impact analytics
...
- [Microsoft Learn: Microsoft 365 Copilot adoption and onboarding guide for IT admins](https://learn.microsoft.com/en-us/microsoft-365/copilot/microsoft-365-copilot-enablement-resources)
- [Microsoft Learn: Microsoft 365 Copilot reporting options for admins](https://learn.microsoft.com/en-us/microsoft-365/copilot/microsoft-365-copilot-reports-for-admins)
- [Microsoft Adoption: Copilot Success Kit](https://adoption.microsoft.com/en-us/copilot/)
- [Microsoft Copilot Dashboard (Copilot Analytics in Viva Insights)](https://learn.microsoft.com/en-us/viva/insights/org-team-insights/copilot-dashboard)
- [Microsoft Learn: Organizational messages in the Microsoft 365 admin center](https://learn.microsoft.com/en-us/microsoft-365/admin/misc/organizational-messages-microsoft-365)
