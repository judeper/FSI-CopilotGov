...
|----------------|-------------------|-------------|
| **BizChat (M365 Chat)** | Critical | Searches across all workloads -- architecture quality directly affects response relevance |
...
- **Related Controls:** [1.1 Copilot Readiness Assessment](1.1-copilot-readiness-assessment.md), [1.7 SharePoint Advanced Management](1.7-sharepoint-advanced-management.md), [1.4 Semantic Index Governance](1.4-semantic-index-governance.md)
