...
| **Catalog Management** | Auto-groups sites by attributes for targeted governance policies | Included with SAM (Public Preview) |
| **SharePoint Admin Agent** | AI-powered proactive risk monitoring for SharePoint governance | Included with SAM (Public Preview) |
...
### SharePoint Admin Agent (Public Preview)

The **SharePoint Admin Agent** (also known as the **Content Governance Agent**) is an AI-powered assistant for SharePoint Admins that provides proactive risk monitoring and governance recommendations.
