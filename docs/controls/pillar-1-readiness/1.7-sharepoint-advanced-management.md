...
**FSI relevance:** Run the Content Management Assessment before Copilot deployment to establish a baseline of content governance posture. Microsoft recommends using Content Management Assessment and DAG reports to identify high-risk sites and oversharing signals before broad Copilot and agentic experiences. Organizations should rerun CMA at least every 30 days during active remediation and compare results against previous baselines to track governance improvement.
...
SAM's site lifecycle management policies help reduce Copilot's exposure to stale content:
