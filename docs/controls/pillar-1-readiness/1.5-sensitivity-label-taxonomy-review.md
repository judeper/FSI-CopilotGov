...
|----------------|-----------------|-------------------|
| **BizChat (M365 Chat)** | Critical | Cross-workload responses may combine content from multiple label levels |
...
- Copilot interaction channels (BizChat, Teams, etc.) are covered by DLP policies
