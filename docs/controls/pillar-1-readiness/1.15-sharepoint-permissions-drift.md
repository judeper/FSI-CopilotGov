...
- **Playbooks:** Playbook 1.15.1 (Permissions Baseline Capture), Playbook 1.15.2 (Drift Scan Deployment and Scheduling), Playbook 1.15.3 (Auto-Revert Policy Configuration), Playbook 1.15.4 (Drift Remediation and Evidence Management)
