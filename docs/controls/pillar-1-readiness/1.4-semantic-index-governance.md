...
|---------|-------------|-------|
| **Authoritative sites** | SharePoint sites designated as high-trust sources for Copilot Search ranking | Up to 100 sites |
| **Bookmarks** | Admin-defined answers that appear prominently for specific search queries | Managed from M365 Admin Center > Copilot > Search |
| **Acronyms** | Organization-specific acronym definitions surfaced by Copilot and Microsoft Search | Managed from M365 Admin Center > Copilot > Search |
