...
>
> - **Anthropic** has been a Microsoft 365 Copilot subprocessor since **January 7, 2026** (full availability expected by the end of March 2026). Anthropic models are provided under the Microsoft Product Terms and Microsoft Data Protection Addendum (DPA), but per Microsoft's published guidance, Anthropic models are **out of scope for the EU Data Boundary and, when available, in-country LLM processing commitments**. Anthropic models are **on by default for most commercial-cloud customers (excluding EU/EFTA and UK)**. Financial institutions should include Anthropic in their third-party risk assessment scope and confirm whether their tenant has Anthropic enabled by default.
...
>
> Review Microsoft's published subprocessor list (Service Trust Portal) and the AI providers settings under M365 Admin Center > Copilot > Settings > View all to confirm which providers are currently available to the tenant.
...
| **Data boundary** | EU Data Boundary and contractual data residency commitments apply to Microsoft-hosted Copilot processing; **Anthropic models (Microsoft subprocessor since Jan 7, 2026) are out of scope for the EU Data Boundary and in-country LLM processing commitments**; **xAI models are processed outside Microsoft-managed environments entirely and are not covered by Microsoft's data residency commitments** | Review data residency documentation; confirm provider-specific exclusions in Microsoft 365 Copilot privacy and "Connect to AI models" Learn pages |
...
| **Regulated** | All Recommended requirements plus: engage legal counsel to review Microsoft contractual terms for AI service provisions and the separate xAI Terms of Service / Data Processing Addendum where xAI is enabled. Conduct fourth-party risk assessment for AI subprocessors (including Anthropic, with explicit documentation of the EU Data Boundary / in-country LLM processing exclusion) and a discrete vendor risk assessment for any independent providers (xAI) whose services fall outside the Microsoft DPA. Evaluate Microsoft's AI incident response capabilities. Assess concentration risk and develop contingency plans. Include AI vendor risk in board risk committee reporting. Conduct annual vendor risk re-assessment. Maintain vendor risk documentation in regulatory examination file. | Comprehensive AI vendor risk management that meets interagency guidance expectations with legal review, fourth-party assessment, board reporting, and examination readiness, including provider-specific data-boundary exceptions. |
