...
|----------------|---------------------|-------|
| **BizChat (M365 Chat)** | Critical | Broadest data processing scope across all M365 workloads |
...
- **Related Controls:** [1.1 Copilot Readiness Assessment](1.1-copilot-readiness-assessment.md), [1.9 License Planning](1.9-license-planning.md), Pillar 3 Compliance Controls
