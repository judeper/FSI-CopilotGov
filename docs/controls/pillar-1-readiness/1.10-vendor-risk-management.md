...
- [Microsoft Subprocessor List](https://learn.microsoft.com/en-us/compliance/regulatory/offering-microsoft-subprocessors-list)
...
- **Playbooks:** Playbook 1.10.1 (AI Vendor Risk Assessment Questionnaire), Playbook 1.10.2 (Microsoft Due Diligence Package Checklist), Playbook 1.10.3 (Subprocessor Assessment Template), Playbook 1.10.4 (Board Reporting Template for AI Vendor Risk)
