...
>
> Review Microsoft's published subprocessor list (Service Trust Portal) and the AI provider settings under M365 Admin Center > Copilot > Settings > View all to confirm which providers are currently available to the tenant. Anthropic appears under **AI providers operating as Microsoft subprocessors**; SpaceXAI appears under **AI providers for other large language models**. Changing the Anthropic setting requires the Entra AI Administrator or Entra Global Admin role; changing the SpaceXAI setting requires the Entra Global Admin role. Provider terms, default states, and portal paths were reverified against Microsoft Learn on **2026-09-22**.
