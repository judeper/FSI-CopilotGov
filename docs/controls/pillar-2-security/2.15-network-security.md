...
|-------------------|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes (via M365) | Yes | Web-based and desktop client |
...
- **Related Controls:** [2.3 Conditional Access](2.3-conditional-access-policies.md), [2.8 Encryption](2.8-encryption.md), [2.9 Defender for Cloud Apps](2.9-defender-cloud-apps.md)
