...
|-------------------|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes | Yes | Primary extensibility surface |
...
- **Related Controls:** [2.3 Conditional Access](2.3-conditional-access-policies.md), [2.5 Data Minimization](2.5-data-minimization-grounding-scope.md), [2.14 Declarative Agents](2.14-declarative-agents-governance.md)
