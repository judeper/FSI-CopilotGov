...
|-------------------|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes | Yes (if enabled) | Primary web search surface |
...
- **Related Controls:** [2.5 Data Minimization](2.5-data-minimization-grounding-scope.md), [2.7 Data Residency](2.7-data-residency.md), [2.14 Declarative Agents](2.14-declarative-agents-governance.md)
