...
5. For GCC or DoD tenants, verify the default-off behavior and enable web search only through this Cloud Policy setting if approved
...
### Step 5: Configure SharePoint Agent Web Search
