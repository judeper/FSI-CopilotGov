...
|-------------------|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes | Yes | Primary grounding scope concern |
...
3. **Exclusion Enforcement:** Query BizChat for content known to exist on an excluded site — confirm no results are returned from that site
4. **Allow List Enforcement:** Query BizChat for content on an allowed site — confirm results are returned normally
...
- [Data Access Governance in Microsoft Purview](https://learn.microsoft.com/purview/data-access-governance)
...
- [Manage Site Access for Copilot](https://learn.microsoft.com/sharepoint/copilot-site-access)
- **Related Controls:** [2.1 DLP Policies](2.1-dlp-policies-for-copilot.md), [2.4 Information Barriers](2.4-information-barriers.md), [2.12 External Sharing](2.12-external-sharing-governance.md)
