...
4. Auto-apply results: Remove access to the reviewed resource for denied guests and, where policy requires, guests who do not respond. A denial in a Team, group, or application review is a resource-access decision only; it must not by itself trigger a tenant-wide guest-account block or deletion.
