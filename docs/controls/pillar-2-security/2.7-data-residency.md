...
|-------------------|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes | Yes | Cross-workload processing in user's geo |
...
- **Related Controls:** [2.6 Web Search Controls](2.6-web-search-controls.md), [2.8 Encryption](2.8-encryption.md), [2.15 Network Security](2.15-network-security.md)
