...
4. For Copilot Studio agents: enable the **Copilot Studio** real-time protection step in the same **Get started** page, then share the generated App ID with the organization's Power Platform administrator to complete onboarding in Power Platform
5. Review and customize detection sensitivity thresholds (default thresholds may generate high false-positive rates during initial deployment)
