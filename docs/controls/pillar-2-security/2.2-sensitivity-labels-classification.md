...
Microsoft's **[Secure by Default deployment model](https://learn.microsoft.com/en-us/purview/deploymentmodels/depmod-securebydefault-intro)** provides an alternative approach to sensitivity labeling at scale by deriving file labels from site (container) labels rather than relying on manual user labeling or auto-labeling alone:
...
- [Microsoft Purview Secure by Default deployment model](https://learn.microsoft.com/en-us/purview/deploymentmodels/depmod-securebydefault-intro) — Microsoft's recommended alternative labeling deployment approach that derives file labels from site (container) labels, enabling rapid labeling scale with minimal user interaction
