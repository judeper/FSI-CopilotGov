...
**Regulatory Reference:** GLBA 501(b), Reg S-P, FFIEC, OCC Bulletin 2013-29
...
- **OCC Bulletin 2013-29 (Third-Party Risk Management)** requires risk management throughout the third-party relationship lifecycle — each federated connector vendor (Canva, HubSpot, Notion, Linear, Google services) is a third-party data processor
