...
| **DLP coverage** | Indexed data subject to applicable Microsoft 365 DLP policies | Connector data relies on source and explicitly supported enforcement paths; don't assume generated-response SIT scanning |
...
User authenticates personal/work account with third-party service
              ...
              (no general Copilot output-SIT scan;
               validate source and supported-path controls)
```
...
| 6 | Test and document DLP boundaries for connector data | Source controls and explicitly supported Copilot DLP paths are evidenced; generated-response SIT scanning isn't assumed | Regulated |
