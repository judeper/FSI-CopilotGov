...
| **Risky Agents** (preview) | Agent activity (default policy present) | Risky prompts, sensitive responses, access to sensitive data, risky websites, external SharePoint sharing | Agent-level misuse of Copilot Studio and Microsoft Foundry agents |
...
- **Agent Supervisory Obligations:** Per FINRA 2026 Oversight Report, the deployment of Copilot Studio and Microsoft Foundry agents creates supervisory obligations that parallel traditional employee supervision. Firms should treat Risky Agents alerts with the same investigation rigor applied to human user alerts.
...
2. **Risky Agents Policy:** Confirm the default Risky Agents (preview) policy is present and active for Copilot Studio and Microsoft Foundry agents; verify alert routing is configured
