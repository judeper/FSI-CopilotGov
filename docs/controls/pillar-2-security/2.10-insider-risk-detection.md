...
### Content Preview in IRM Alerts (April 2026)

IRM alerts now support **inline content preview**, allowing investigators to view the flagged content directly within the alert interface without navigating to a separate review or investigation screen. This enhancement applies to alerts generated from Copilot activity signals, Communication Compliance integration, and DLP matches.

- **Workflow improvement:** Investigators can assess alert severity and context faster by previewing the relevant Copilot interaction, flagged communication, or matched content inline — reducing mean time to triage
...
### Enhanced Risky AI Usage Indicators for Copilot (April 2026)

IRM has updated its risky AI usage indicator set with expanded coverage for Copilot-specific risk scenarios:
