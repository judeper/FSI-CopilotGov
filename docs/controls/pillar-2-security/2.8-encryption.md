...
|-------------------|:---:|:---:|:---:|:---:|-------|
| BizChat (M365 Chat) | Yes | Yes | Yes | Yes | All transport and storage encrypted |
...
- **Related Controls:** [2.2 Sensitivity Labels](2.2-sensitivity-labels-classification.md), [2.3 Conditional Access](2.3-conditional-access-policies.md), [2.7 Data Residency](2.7-data-residency.md)
