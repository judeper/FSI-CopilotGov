...
| **Third-party AI apps** (sanctioned) | 2.9 (Defender Cloud Apps catalog), 2.7 (data residency), 2.13 (connector security) | Partial — visible in inventory, limited policy enforcement | Manage via MDCA generative AI app catalog; apply only currently documented DLP/session controls and validate their enforcement paths |
