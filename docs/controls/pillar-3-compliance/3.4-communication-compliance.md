...
FINRA Rule 3110 requires member firms to establish and maintain a system to supervise the activities of each associated person that is reasonably designed to achieve compliance with applicable securities laws and FINRA rules. This supervisory obligation extends to all forms of business communication, including Copilot-assisted communications. FINRA Rule 2210 imposes specific content standards on communications with the public, requiring that content be fair, balanced, and not misleading. SEC Regulation Best Interest requires that broker-dealers act in the best interest of retail customers when making recommendations.
...
This control covers the configuration of Communication Compliance policies that target Copilot-assisted communications, including policy design, keyword detection, trainable classifiers, review workflows, escalation procedures, and integration with supervisory review obligations.
...
| **Microsoft 365 Chat (BizChat)** | Partial | Exchange Online | BizChat messages stored in Exchange are scannable; review coverage depends on retention configuration |
...
### Step 4: Configure Review Workflow
...
### Step 5: Enable Policy and Monitor
...
- Patterns of violations by specific individuals should trigger enhanced supervision
...
| 7 | Test pre-send review for high-risk communications | Copilot-drafted messages to high-risk clients are held for supervisory approval | Regulated |
| 8 | Verify FINRA 3120 testing documentation | Annual testing records demonstrate communication compliance effectiveness | Regulated |
| 9 | Confirm integration with compliance case management | Flagged items create cases in the firm's compliance system | Recommended |
| 10 | Review communication compliance trend report | Quarterly report shows detection volumes, review outcomes, and Copilot-specific violation patterns | Regulated |
