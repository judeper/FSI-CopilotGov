...
2. Select **+ Create policy** > **Detect Microsoft 365 Copilot interactions**
...
| **Copilot Pages** | No direct artifact scan established | SharePoint Embedded | A link can appear in a monitored message; don't infer that Communication Compliance scans the underlying Page content |
| **Copilot Notebooks** | No direct artifact scan established | SharePoint Embedded | A link can appear in a monitored message; don't infer that Communication Compliance scans the underlying Notebook content |
