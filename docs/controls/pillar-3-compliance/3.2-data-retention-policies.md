...
| 3 | Verify Copilot Pages and Copilot Notebooks are covered by retention | Artifacts in their user-owned SharePoint Embedded container are covered through the **All SharePoint Sites** retention scope and are discoverable through the supported eDiscovery workflow | Baseline |
