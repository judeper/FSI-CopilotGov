...
**Regulatory Review:** Pending — legal/compliance questions tracked in judeper/OceanSquad#241
...
|-------------|---------------|-----------------|-------------------|------------------|
| Microsoft 365 Copilot Chat history | Microsoft Copilot experiences (user mailbox hidden folder) | Business communication candidate | 3 years | FINRA 4511, SEC 17a-4(b)(4); firms should confirm applicability with counsel |
| Copilot-drafted emails (sent) | Exchange Online | Business correspondence candidate | 3 years | SEC 17a-4(b)(4); firms should confirm applicability with counsel |
| Copilot-drafted emails (client-facing) | Exchange Online | Customer correspondence candidate | 6 years | SEC 17a-4(a); firms should confirm applicability with counsel |
| Copilot Pages | SharePoint Embedded user-owned container (retention applied through All SharePoint Sites) | Business record candidate | 3 years | FINRA 4511; firms should confirm applicability with counsel |
| Teams meeting recaps (Copilot) | Microsoft Copilot experiences / Teams-Exchange | Business communication candidate | 3 years | FINRA 4511, SEC 17a-4(b)(4); firms should confirm applicability with counsel |
| Teams meeting transcripts | Teams / Exchange | Business communication candidate | 3 years | FINRA 4511; firms should confirm applicability with counsel |
| Teams chat Copilot interactions | Microsoft Copilot experiences / Teams-Exchange | Business communication candidate | 3 years | FINRA 4511, SEC 17a-4(b)(4); firms should confirm applicability with counsel |
| Word/Excel/PowerPoint Copilot drafts | SharePoint / OneDrive | Business record candidate | 6 years (if financial) | SEC 17a-4(a), SOX 802; firms should confirm applicability with counsel |
| Copilot-assisted financial analyses | SharePoint / OneDrive | Financial record candidate | 6 years | SEC 17a-3(a)(2), SOX 802; firms should confirm applicability with counsel |
| Copilot audit log events | Purview UAL | Audit trail candidate | 6 years | SEC 17a-4(a), FINRA 4511; firms should confirm applicability with counsel |
...
- Retention policies should be designed to cover both the source content location (e.g., Teams channel messages) and the summary storage location (e.g., Microsoft Copilot experiences) where the firm determines both artifacts are in scope; firms should confirm applicability with counsel.
- FINRA Rule 4511(c) is cited for preservation format and media requirements. Firms should confirm with counsel whether threaded summaries that capture the substance of a business discussion are books and records and how they should be treated in the firm's retention inventory.
...
- Configure WORM-style immutable retention for records the firm identifies as subject to SEC Rule 17a-4(f) requirements — use `New-RetentionComplianceRule` with `-RetentionComplianceAction KeepAndDelete` to support immutable retain-then-delete behavior; firms should confirm WORM applicability with counsel
...
2. Create label:
    ...
    - **Description:** Regulatory record -- financial records retained for the firm's approved period (6 years is a commonly cited SEC 17a-4 example; confirm applicability with counsel)
