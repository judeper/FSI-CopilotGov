...
| Copilot Pages | Microsoft Copilot experiences / OneDrive for Business | Business record | 3 years | FINRA 4511 |
...
Microsoft has reorganized Copilot-related retention locations in Purview into three categories. Understanding this structure is essential for configuring retention policies that provide comprehensive coverage.
...
**Scope guidance for M365 Copilot deployments:** For organizations deploying Microsoft 365 Copilot and Microsoft 365 Copilot Chat, configure retention policies targeting the **Microsoft Copilot experiences** location. This location covers the full range of M365 Copilot interaction history and AI-assisted content creation across Office applications.

The Enterprise AI Apps and Other AI Apps categories exist for awareness: Enterprise AI Apps covers Copilot Studio agents and Power Platform integrations (outside M365 Copilot scope — note for governance planning but do not configure as primary M365 Copilot retention target). Other AI Apps covers third-party AI tools that may be integrated via the Microsoft 365 ecosystem (also outside M365 Copilot scope — mention in governance inventory for completeness). Firms evaluating broader AI governance beyond M365 Copilot should assess those categories separately.
...
| **Copilot Pages** | Page content, collaborative edits | Microsoft Copilot experiences / OneDrive for Business | Copilot experiences + OneDrive retention policy |

## Governance Levels

### Baseline

- Create retention policies covering all Copilot content locations for a minimum of 3 years — required locations: **Exchange Online** (Copilot Chat substrate, Outlook drafts), **SharePoint Online** (Teams channel transcripts, Copilot Pages, team-shared files), **OneDrive for Business** (user-owned Copilot Pages, Loop components, personal files), **Teams Channel messages**, **Teams Chat messages** (1:1/group Copilot interactions, meeting chat responses), **Microsoft 365 Groups** (group mailboxes, associated SharePoint sites), and **Loop** (components stored in OneDrive substrate)
...
- Confirm that Copilot Pages stored in OneDrive are covered by OneDrive retention policies — standalone Copilot Pages reside in the user's OneDrive; no separate location parameter is required
...
- Confirm PowerShell-based policy creation covers all locations — reference: `New-RetentionCompliancePolicy -ExchangeLocation All -SharePointLocation All -OneDriveLocation All -TeamsChannelLocation All -TeamsChatLocation All -ModernGroupLocation All`
...
- Configure retention policies for a minimum of 6 years across all Copilot content locations including Microsoft Copilot experiences — example PowerShell with 7-year FSI standard: `New-RetentionCompliancePolicy -Name "FSI-Copilot-7yr-Retention" -ExchangeLocation All -SharePointLocation All -OneDriveLocation All -TeamsChannelLocation All -TeamsChatLocation All -ModernGroupLocation All` followed by `New-RetentionComplianceRule -Policy "FSI-Copilot-7yr-Retention" -RetentionDuration 2556 -RetentionComplianceAction Keep`
...
### Step 3: Create OneDrive Retention Policy (Copilot Pages + Documents)
...
### Step 4: Create SharePoint Retention Policy
