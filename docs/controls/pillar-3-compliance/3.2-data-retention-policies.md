...
|-------------|---------------|-----------------|-------------------|------------------|
| Copilot BizChat history | User mailbox (hidden folder) | Business communication | 3 years | FINRA 4511, SEC 17a-4(b)(4) |
...
- **Exchange Online mailboxes:** BizChat history, Copilot-drafted emails, meeting recap summaries
...
|----------------|---------------|-------------------|-------------|
| **Microsoft 365 Chat (BizChat)** | Chat history with Copilot | Exchange mailbox (hidden folder) | Exchange retention policy |
...
- Verify Copilot BizChat history is included in Exchange retention scope
...
### Step 1: Create Exchange Retention Policy (Copilot BizChat + Email)
...
4. Configure:
    ...
    - **Description:** Retains Exchange content including Copilot BizChat history and Copilot-drafted emails for 3 years
...
| 2 | Delete a Copilot BizChat message and verify recovery | Content is recoverable from the Recoverable Items folder within the retention period | Baseline |
