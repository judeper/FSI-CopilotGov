...
- **Customer disclosure:** Customers may have a right to know when AI assists in generating communications, recommendations, or analyses they receive. Several states have enacted or proposed laws that may require disclosure of AI-generated content; firms should confirm applicability with counsel.
...
|-------------|------------|-------------------|
| **Colorado AI Act** | Disclosure when AI makes or substantially contributes to consequential decisions | Potential legal review trigger for Copilot-assisted lending, insurance, or advisory decisions; firms should confirm applicability with counsel |
| **Illinois AI Video Interview Act** | Disclosure when AI analyzes video interviews | Potential legal review trigger if AI analyzes applicant-submitted video interviews; firms should confirm applicability with counsel |
| **California AI Transparency Act (SB 942, enacted; amended by AB 853)** | Covered-provider transparency requirements for AI-generated image, video, and audio content | Vendor/provider due diligence and legal review for any firm-facing disclosure impact; firms should confirm deployer-side duties with counsel |
| **NYC Local Law 144** | Bias audits for automated employment decision tools | Potential legal review trigger for AEDT use cases; firms should confirm applicability to Copilot-assisted HR and employment activities with counsel |
| **Various state privacy laws** | Opt-out rights for profiling and automated decision-making | Potential legal review trigger for Copilot-assisted customer profiling; firms should confirm jurisdiction-specific applicability with counsel |
...
Where disclosure is required by firm policy or law, firms should balance transparency with competitive positioning:
