...
**Regulatory Reference:** SEC Marketing Rule (Rule 206(4)-1), SEC Regulation Best Interest (Reg BI), State AI Disclosure Laws, SEC Press Release 2024-36 (Delphia and Global Predictions AI washing enforcement actions)
...
Establish AI disclosure and transparency controls that help firms evaluate when to inform customers and investors about the use of Microsoft 365 Copilot in financial services activities, provide evidence for SEC Marketing Rule review of misleading AI claims ("AI washing"), and assess emerging state AI disclosure requirements with counsel.

## Why This Matters for FSI

The SEC has taken an increasingly active stance on AI disclosure and transparency in the financial services industry. The SEC Marketing Rule (Rule 206(4)-1), effective May 4, 2021 with a November 4, 2022 compliance date, prohibits investment advisers from making untrue statements of material fact or omitting material facts in marketing materials. The SEC has explicitly extended this prohibition to claims about AI capabilities, issuing enforcement actions against firms that overstated or misrepresented their use of AI in investment management.

When a financial institution deploys Microsoft 365 Copilot, several disclosure and transparency obligations arise:

- **Customer disclosure:** Customers may have a right to know when AI assists in generating communications, recommendations, or analyses they receive. Several states have enacted or proposed laws that may require disclosure of AI-generated content; applicability: confirm.
...
!!! note "Regulatory applicability"
    Regulatory citations in this section identify commonly referenced requirements. Applicability, disclosure duties, record classification, and retention periods depend on the firm's regulatory status; confirm with counsel. See [judeper/OceanSquad#241](https://github.com/judeper/OceanSquad/issues/241).
...
|-------------|------------|-------------------|
| **Colorado AI Act** | Disclosure when AI makes or substantially contributes to consequential decisions | Potential legal review trigger for Copilot-assisted lending, insurance, or advisory decisions; applicability: confirm |
| **Illinois AI Video Interview Act** | Disclosure when AI analyzes video interviews | Potential legal review trigger if AI analyzes applicant-submitted video interviews; applicability: confirm |
| **California AI Transparency Act (SB 942, enacted; amended by AB 853)** | Covered-provider transparency requirements for AI-generated image, video, and audio content | Vendor/provider due diligence and legal review for any firm-facing disclosure impact; deployer-side duties: confirm |
| **NYC Local Law 144** | Bias audits for automated employment decision tools | Potential legal review trigger for AEDT use cases; applicability to Copilot-assisted HR and employment activities: confirm |
| **Various state privacy laws** | Opt-out rights for profiling and automated decision-making | Potential legal review trigger for Copilot-assisted customer profiling; jurisdiction-specific applicability: confirm |

Firms should monitor evolving state AI legislation and update disclosure practices after legal review confirms applicability.
...
| **Copilot Notebooks** | Moderate -- if shared externally | Sharing controls; external sharing disclosure |
...
1. Draft an AI Disclosure Policy that addresses:
    - When AI/Copilot usage must be disclosed to clients, as confirmed by legal/compliance owners
...
- The SEC's March 2024 AI washing enforcement actions demonstrate active scrutiny of AI-related marketing claims
...
Disclosure obligations may differ based on client type and should be confirmed with counsel:
...
For communications the firm classifies as requiring disclosure, disclosure remains required; firms should balance transparency with competitive positioning:
...
- [SEC Press Release 2024-36 — SEC Charges Delphia and Global Predictions With AI Washing](https://www.sec.gov/newsroom/press-releases/2024-36)
