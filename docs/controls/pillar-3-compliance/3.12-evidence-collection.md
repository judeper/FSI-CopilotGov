...
**Regulatory Reference:** Sarbanes-Oxley §§302/404 (where applicable to ICFR), PCAOB Auditing Standards (AS 2201), FINRA 3120 (Supervisory Control System)
...
- Establish Sarbanes-Oxley §§302/404-aligned evidence collection for Copilot-related internal controls
...
# Get-SupervisoryReviewPolicyV2 is the documented Security & Compliance PowerShell
# cmdlet for viewing Communication Compliance / supervisory review policies.
...
### Sarbanes-Oxley §§302/404 Alignment for Public Institutions

For publicly traded financial institutions, Copilot governance controls that affect financial reporting processes must be included in the Sarbanes-Oxley §§302/404 assessment:
...
| 7 | Verify Sarbanes-Oxley §§302/404 evidence for Copilot controls | Evidence meets PCAOB auditing standard requirements | Regulated |
...
### Using Compliance Manager for AI Governance Assessment

Microsoft Purview [Compliance Manager](https://learn.microsoft.com/en-us/purview/compliance-manager) provides pre-built assessments for AI-related regulatory requirements. Organizations can use Compliance Manager to:

- **Assess AI compliance posture:** Use Compliance Manager's AI and data protection assessment templates to evaluate your tenant's readiness against AI regulatory frameworks and Microsoft recommended actions
- **Track improvement actions:** [Compliance Manager improvement actions](https://learn.microsoft.com/en-us/purview/compliance-manager-improvement-actions) provide specific configuration tasks mapped to regulatory requirements. Each action includes implementation guidance, testing procedures, and evidence documentation requirements
- **Assign and monitor remediation:** [Assign improvement actions](https://learn.microsoft.com/en-us/purview/compliance-manager-update-actions) to responsible team members, set implementation status, and track progress toward compliance goals
- **Validate with DSPM:** Use DSPM reports to validate that improvements tracked in Compliance Manager have been implemented effectively

**FSI relevance:** Compliance Manager helps demonstrate systematic regulatory compliance management for examination readiness. Organizations should map Compliance Manager improvement actions to this framework's controls to maintain a unified view of governance posture. Compliance Manager's compliance score should be reported alongside the framework's assessment scorecard in governance committee reviews.
