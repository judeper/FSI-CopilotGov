...
|---------|---------|-----------|-----------|----------------------|--------------------------|
| **Copilot Pages** | User-owned SharePoint Embedded container shared with Copilot Notebooks and Loop My workspace | High — collaborative edits | Yes — explicit branch creates new Page | Limited (link/embed in Teams, Outlook) | Microsoft 365 retention policy using the **All SharePoint Sites** scope; version history within the Page |
...
| SharePoint Embedded, SharePoint, and OneDrive | Storage | Storage | Storage | Copilot Pages use SharePoint Embedded; OneNote and other Loop artifacts use their documented storage surfaces |
...
1. Identify the user-owned SharePoint Embedded containers that host Copilot Pages. Pages and Copilot Notebooks use the same container as Loop My workspace and aren't stored in the user's traditional OneDrive.
...
1. Create or extend retention policies that use **All SharePoint Sites** for Copilot Pages' SharePoint Embedded containers and cover the separately identified OneDrive/SharePoint locations for OneNote and other Loop artifacts.
...
3. Verify the **All SharePoint Sites** scope covers the SharePoint Embedded container used by Copilot Pages.
...
|---|------------------|------------------|------------------|
| 1 | Confirm Copilot Pages, OneNote Notebooks, and Loop components are within scope of a Microsoft 365 retention policy | **All SharePoint Sites** covers the Copilot Pages SharePoint Embedded container; separate OneDrive/SharePoint scopes cover the documented OneNote and Loop locations | Baseline |
...
- [Copilot Pages and Copilot Notebooks compliance summary](https://learn.microsoft.com/en-us/microsoft-365/loop/cpcn-compliance-summary?view=o365-worldwide)
