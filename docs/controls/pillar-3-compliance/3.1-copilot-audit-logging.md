...
- Configure search queries for AgentAdminActivity and AgentSettingsAdminActivity record types

### Regulated

- Configure audit retention policies for 6+ years to meet SEC Rule 17a-4(a) requirements using E5 Audit Premium or PAYG billing with governance controls
...
- Establish a JailbreakDetected response procedure — events must be investigated and escalated per the firm's security incident response plan
