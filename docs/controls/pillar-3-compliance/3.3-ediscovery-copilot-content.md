...
|-------------|--------------------|--------------------|
| BizChat history | Exchange mailbox (hidden folder) | Custodian mailbox search -- BizChat is stored in a subfolder of the user's mailbox |
...
| Copilot BizChat search | Yes | Yes |
...
**Search for Copilot BizChat conversations containing specific terms:**
...
|----------------|-------------|----------------|---------------|
| **Microsoft 365 Chat (BizChat)** | Yes -- via Exchange mailbox search | Yes -- mailbox hold | EML, PST |
...
- Confirm that Copilot BizChat content appears in Exchange mailbox content searches
...
3. For each custodian, verify the following locations are selected for hold:
    - Exchange mailbox (includes BizChat history)
...
|---|------------------|-------------------|------------------|
| 1 | Run a content search for CopilotInteraction content | BizChat history appears in search results | Baseline |
