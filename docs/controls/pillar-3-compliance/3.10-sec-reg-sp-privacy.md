...
- Configure current Data Security Posture Management AI hub reports to review AI observability for SITs in Copilot prompts and responses, use AI hub > Reports > Oversharing assessments for oversharing of labeled content (e.g., Confidential — Customer Data), and track remediation through Recommendations
...
- Implement the full amended Reg S-P incident response workflow: (1) Detection via Data Security Posture Management / DLP alert → routed to privacy/compliance team; (2) Assessment within ≤72 hours — determine whether the firm must notify Microsoft as the service provider under Rule 248.30(a)(3), and cross-check Azure Service Health for any Microsoft-originated incident notice; (3) Scope determination via UAL audit logs + DSPM AI observability and prompt/response data to identify which customer NPI was exposed; (4) Customer notification ≤30 days after determination of misuse or reasonably likely misuse; note: no SEC notification obligation under Reg S-P unless a separate reportable cybersecurity event under Reg S-K Item 1.05 or SAR requirements triggers independently
...
!!! info "New Feature — February 2026"
