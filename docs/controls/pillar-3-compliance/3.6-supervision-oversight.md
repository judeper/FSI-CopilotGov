...
Establish written supervisory procedures, qualified supervisor assignments, ongoing supervisory activities, and annual testing programs that address Microsoft 365 Copilot usage by associated persons. These controls provide evidence for FINRA Rule 3110 and SEC Regulation Best Interest review; firms should confirm applicability to AI-assisted activities and Microsoft 365 Copilot agents with counsel.
...
FINRA Regulatory Notice 24-09 reminds firms that existing supervisory obligations can apply to AI-generated content and AI tool use by associated persons. Firms should confirm with counsel how that guidance applies to their Copilot deployment; human supervisory oversight remains the control design assumption.
...
|-----------|-----------|---------------------|
| **Written supervisory procedures** | 3110(b) | WSPs should specifically address Copilot usage policies, prohibited activities, review requirements, and escalation procedures; firms should confirm applicability with counsel |
| **Supervisory system** | 3110(a) | The overall system should account for Copilot where the firm treats it as a tool used in supervised activities; firms should confirm applicability with counsel |
| **Qualified supervisor** | 3110(a) | Designated supervisors should understand Copilot capabilities and limitations; firms should confirm registration and qualification expectations with counsel |
| **Review of communications** | 3110(b)(4) | Supervisory review should cover Copilot-assisted communications where the firm determines they are in scope; firms should confirm applicability with counsel |
| **Review of customer accounts** | 3110(b)(2) | Supervisory review of Copilot-assisted account activities |
| **Annual compliance meeting** | 3110(a)(7) | Annual meeting should address Copilot usage where the firm determines it is in scope; firms should confirm applicability with counsel |
| **Supervisory control system** | 3120 | Supervisory controls should test Copilot-specific procedures where approved by firm policy; firms should confirm applicability with counsel |
| **Annual testing** | 3120(b) | Annual testing should include Copilot-related supervisory procedures, including AI tool supervision effectiveness, when approved by firm policy; firms should confirm applicability with counsel |
| **Agent supervision** | 3110(a), 3120 | WSPs should address each deployed Copilot agent's scope, authorized actions, and supervisory review cadence where agents are in scope; firms should confirm applicability with counsel |
...
FINRA's evolving supervisory expectations signal that firms should assess whether FINRA Rule 3110(a) supervisory systems need to cover autonomous and semi-autonomous agent actions. For Microsoft 365 Copilot, firms should confirm with counsel whether the following agent types belong within written supervisory procedures:
...
| **Teams channel agents** | Automated responses to user queries within Teams channels | Assess for supervisory review under FINRA 3110(a); firms should confirm WSP coverage expectations with counsel |
...
- Establish a post-use review sampling rate for Copilot-assisted correspondence via **CC policy > Review percentage > 1–100%** (5% is a firm policy example; confirm the approved threshold with compliance/legal; portal-only configuration; not available via PowerShell)
...
- Increase post-use review sampling rate to the firm's approved threshold for Copilot-assisted communications (25% is an FSI policy example; confirm with compliance/legal); configure via **CC policy > Review percentage** in the Purview portal
...
- Escalate to 100% review sampling rate for priority users (executives, trading desk, M&A staff) when approved as firm policy via **CC policy > Review percentage**
...
2. Verify supervisors hold registrations approved by the firm's compliance/legal owners (Series 24, Series 26, or equivalent are examples to confirm with counsel)
...
2. Set sampling rates:
    ...
    - Recommended: 25% of Copilot-assisted communications as a firm policy example
    - Regulated: 100% of outbound Copilot-assisted client communications as a firm policy example (pre-send review)
