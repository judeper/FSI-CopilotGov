...
!!! note "Regulatory applicability"
    Regulatory citations in this section identify commonly referenced requirements. Applicability, source identity, record classification, and retention periods depend on the firm's regulatory status; confirm with counsel. See [judeper/OceanSquad#241](https://github.com/judeper/OceanSquad/issues/241).
...
!!! warning "FFIEC CAT Sunset"
    The FFIEC Cybersecurity Assessment Tool (CAT) was sunset on August 31, 2025. Organizations should transition to NIST CSF 2.0, CISA CPGs, or the CRI Profile for cybersecurity maturity assessment. The CAT guidance below is retained as legacy context for institutions completing their transition.
...
| **Copilot Notebooks** | Operations, Information Security | Collaborative content governance |
...
- Complete the FFIEC IT Handbook mapping for all deployed Copilot governance controls, focusing on the most relevant booklets:
    ...
    - **Audit** (2003): Audit expertise for AI tools, risk-based testing frequency, remediation tracking
    - **Management** (2015): Board-level AI governance, vendor management oversight
    - Note: The Architecture, Infrastructure & Operations (AIO) booklet (2021) supersedes the former Operations booklet; no standalone FFIEC AI booklet is listed in the FFIEC IT Booklets index as of September 2026
...
- Align evidence collection (Control 3.12) with FFIEC examination expectations, mapping to key examination procedures:
    ...
    - **Audit (2003):** Confirm internal audit has access and expertise to test AI tool controls, apply risk-based testing frequency, track Copilot-related findings to remediation
- Conduct annual FFIEC CAT self-assessment updates incorporating Copilot
- Map all {{ counts.controls }} FSI Copilot Governance Framework controls to applicable FFIEC booklet requirements
...
- Commission independent FFIEC readiness assessment for Copilot governance, covering all relevant booklets (Information Security, AIO, Audit, Management) and supplemental guidance (OCC Bulletin 2026-13 / Federal Reserve SR 26-2 revised Model Risk Management guidance, with OCC Bulletin 2025-26 retained as community-bank proportionality context)
- Maintain continuously updated FFIEC mapping documentation; in the absence of a standalone FFIEC AI booklet, rely on AIO (2021) as the primary FFIEC handbook reference for AI/ML technology-risk coverage; use OCC Bulletin 2026-13 / SR 26-2 only as current model-risk-management context, with the explicit caveat that generative and agentic AI models are outside that guidance's scope, and retain OCC Bulletin 2025-26 as community-bank proportionality context
...
1. Download or reference the current FFIEC IT Examination Handbook booklets:
    ...
    - Architecture, Infrastructure & Operations (AIO) (2021)
    - Audit (2003)
    - Management (2015)
...
- Testing results (Sarbanes-Oxley §§302/404, FINRA 3120)
...
FFIEC member agencies have been cited as issuing joint guidance on AI technology ([**Interagency Guidance on AI (2023)**](https://www.federalregister.gov/documents/2023/04/13); source identity pending confirmation). Institutions should monitor for:
...
- [FFIEC Architecture, Infrastructure & Operations (AIO) Booklet](https://ithandbook.ffiec.gov/it-booklets/architecture-infrastructure-and-operations/)
- [FFIEC Cybersecurity Assessment Tool Sunset Announcement](https://www.ffiec.gov/news/press-releases/2024/an-09-29)
