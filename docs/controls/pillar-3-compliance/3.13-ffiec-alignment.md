...
- Complete the FFIEC IT Handbook mapping for all deployed Copilot governance controls, focusing on the most relevant booklets:
    ...
    - Note: The Architecture, Infrastructure & Operations (AIO) booklet (2021) supersedes the former Operations booklet; no standalone FFIEC AI booklet exists as of March 2026
...
- [FFIEC Cybersecurity Assessment Tool (Sunset August 2025; transition to NIST CSF 2.0)](https://www.ffiec.gov/press/PDF/CAT_Sunset_Statement.pdf)
