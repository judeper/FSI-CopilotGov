...
The citation currently labeled **Interagency Guidance on AI (2023)** is retained pending source confirmation (source identity pending confirmation). Institutions should monitor for:
