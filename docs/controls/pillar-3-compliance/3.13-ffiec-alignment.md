...
!!! note "Regulatory applicability"
    Regulatory citations in this section identify commonly referenced requirements. Applicability, source identity, record classification, and retention periods depend on the firm's regulatory status; confirm with counsel. See judeper/OceanSquad#241.
