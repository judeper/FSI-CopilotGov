...
SEC Rule 17a-4 imposes specific technical requirements for electronic storage, including the requirement that records be preserved in a non-rewriteable, non-erasable format -- commonly referred to as WORM (Write Once, Read Many) storage. But Rule 17a-4(f)(2) -- as amended by the SEC's 2022 electronic recordkeeping amendments (SEC Release No. 34-96034, 87 FR 66412 (Nov. 3, 2022)) -- provides an **audit-trail alternative** where records need not be stored in non-rewriteable format if the broker-dealer maintains the required audit trail for the record throughout its retention period. For Copilot content governed through Microsoft Purview, Purview audit evidence may support the firm's audit-trail alternative assessment, subject to firm/counsel and records-management approval.
...
**Audit-trail alternative (Rule 17a-4(f)(2)):** As an alternative to non-rewriteable storage, a broker-dealer may instead preserve records in a manner that maintains the rule-required audit trail throughout the record's retention period. The legal audit-trail alternative does not require WORM-formatted storage but requires a complete time-stamped audit trail for modifications and deletions, plus the other information needed to maintain authenticity and permit re-creation of the original record if modified or deleted. This framework's firm-internal control baseline remains stronger: every access, modification, and deletion attempt should be recorded and preserved for the full retention period where the firm relies on audit evidence for examination readiness.

For Copilot content in Microsoft Purview, Purview regulatory record labels, Preservation Lock, and Purview audit evidence may support the firm's audit-trail alternative assessment, subject to firm/counsel and records-management approval:
...
- **Option A:** Retention labels with regulatory record declaration + Preservation Lock (potential audit-trail alternative support, subject to firm/counsel approval)
...
Retention Policy Applied (Purview)
        |
        v
WORM Archive Created (Option B) OR Audit Trail Preserved (Option A: Rule 17a-4(f)(2))
        |
        v
...
| **Copilot Notebooks** | Collaborative business records | 17a-4(b)(4) or (a) depending on content | Yes -- 3-6 years |
...
- Document the firm/counsel-approved 17a-4(f) posture selected for Copilot records (Purview-supported audit-trail assessment, third-party WORM archival, or both) with supporting rationale
...
- Implement the firm/counsel-approved SEC Rule 17a-4(f) posture for Copilot records — either via **Option A** (Purview regulatory record labels + Preservation Lock + audit evidence as support for the firm's Rule 17a-4(f)(2) assessment), **Option B** (third-party WORM archival with vendor attestation), or both
- For **Option A** (Purview-supported audit-trail assessment per Rule 17a-4(f)(2)): leverage **SharePoint Preservation Hold Library** evidence — provides audit trail of record creation and immutability when combined with retention hold; the system must automatically verify recording quality/accuracy, serialize and time-date stamp records, and support download to a readable format
...
- Conduct annual SEC 17a-4 compliance assessment for Copilot records with documented results, including firm/counsel review of whether the Purview-supported audit evidence supports the firm's Rule 17a-4(f)(2) assessment
...
**Option A: Microsoft Purview Audit-Trail Alternative (Rule 17a-4(f)(2))**
...
5. Document the compliance approach in writing: confirm with 17a-4 compliance counsel that the Purview audit configuration meets Rule 17a-4(f)(2) requirements
...
- **Attestation requirements:** SEC Rule 17a-4(f)(3) requires a representation from the storage media vendor (or third-party provider) that the storage meets WORM requirements; the audit-trail alternative path under Rule 17a-4(f)(2) requires comprehensive audit trail coverage rather than a vendor attestation
...
### Cohasset Associates Compliance Assessment (December 2024)

In December 2024, Microsoft partnered with **Cohasset Associates** to produce an independently verified compliance assessment covering Microsoft 365 Copilot and Microsoft Loop for SEC Rule 17a-4, FINRA Rule 4511, and CFTC Rule 1.31. The assessment is available on the [Microsoft Service Trust Portal](https://servicetrust.microsoft.com/).

- **Scope:** The assessment evaluates whether Microsoft 365 Copilot and Loop content — when governed through proper Microsoft Purview configuration — can meet WORM and audit-trail requirements under SEC Rule 17a-4(f), FINRA Rule 4511, and CFTC Rule 1.31
- **Key finding:** With correct Purview retention policy configuration (including Preservation Lock and regulatory record labels), Copilot and Loop content can satisfy the electronic storage requirements of these rules
- **Citable artifact:** The Cohasset Associates assessment is an independently produced document that firms can reference during SEC and FINRA examinations to support their 17a-4 compliance posture for Copilot content
- **Important caveat:** The assessment confirms that the Microsoft 365 platform supports compliance when properly configured — organizations remain responsible for verifying that their specific Purview configuration meets the assessment's assumptions and their regulatory obligations

Firms pursuing either the audit-trail alternative (Option A) or third-party WORM archival (Option B) should review the Cohasset Associates assessment as part of their 17a-4 compliance documentation and retain a copy in their examination readiness file.
...
| 6 | Verify 17a-4(f) compliance approach is documented | Firm/counsel-approved Option A (Purview-supported audit-trail assessment per Rule 17a-4(f)(2)), Option B (WORM vendor attestation), or both are selected and documented | Recommended |
...
| 9 | Verify WORM storage compliance or audit-trail alternative posture | Records are stored per the firm/counsel-approved 17a-4(f) posture with appropriate documentation | Regulated |
