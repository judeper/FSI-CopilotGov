...
|-----------|------------|----------------|----------|-----------|
| **FINRA 4530(d)** | Quarterly statistical report | Written customer complaints about Copilot-assisted activities | By the 15th day of the month following the calendar quarter | FINRA |
| **FINRA 4530(a)/(b)** | Event-driven report | External findings/events under 4530(a), or the firm's own conclusion under 4530(b) that the member or associated person violated covered laws, rules, regulations, or standards of conduct in a Copilot-related matter | Within 30 calendar days | FINRA |
...
| **SEC Reg S-ID** | Identity Theft Prevention Program / Red Flags assessment | Copilot processes identity-related customer data in covered accounts | Periodic covered-account/program updates; at least annual board or senior-management report | SEC |
