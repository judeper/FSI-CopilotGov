...
|-----------|------------|----------------|----------|-----------|
| **FINRA 4530(d)** | Quarterly statistical report | Written customer complaints about Copilot-assisted activities | By the 15th day of the month following the calendar quarter | FINRA; firms should confirm applicability with counsel |
| **FINRA 4530(a)/(b)** | Event-driven report | External findings/events under 4530(a), or the firm's own conclusion under 4530(b) that the member or associated person violated covered laws, rules, regulations, or standards of conduct in a Copilot-related matter | Within 30 calendar days | FINRA; firms should confirm applicability with counsel |
| **SOX 302** | CEO/CFO certification | AI-assisted financial reporting workflows include Copilot | Quarterly (with 10-K/10-Q) | SEC; firms should confirm applicability with counsel |
| **Sarbanes-Oxley §404** | Internal control assessment | Copilot used in financial reporting processes | Annual (with 10-K) | SEC; firms should confirm applicability with counsel |
| **GLBA §501(b)** | Safeguard program documentation | Copilot accesses customer financial information | Annual review; report on breach as a planning example | Regulator depends on entity type; firms should confirm applicability, cadence, and recipient with counsel |
...
| **SEC Reg S-ID** | Identity Theft Prevention Program / Red Flags assessment | Copilot processes identity-related customer data in covered accounts | Periodic covered-account/program updates; at least annual board or senior-management report | SEC; firms should confirm applicability with counsel |
| **State data breach** | Breach notification | Copilot-related data incident involving PII | Varies by state (24h-60 days) | State AG / affected consumers; firms should confirm jurisdiction-specific applicability with counsel |
...
Under GLBA §501(b) and related regulator-specific safeguard regimes, financial institutions may need to document safeguard programs that protect customer information. When Copilot accesses customer financial information, firms should confirm the applicable regime, cadence, and recipient with counsel:
