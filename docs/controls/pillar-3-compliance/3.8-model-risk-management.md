...
!!! tip "Future direction — generative-AI MRM (control 3.8a)"
    The framework will introduce a forward-looking control **3.8a — Generative AI Model Governance** synthesizing SR 11-7 / OCC 2011-12 principles with emerging genAI-specific guidance (NIST AI RMF, ISO/IEC 42001) when **either** of the following triggers occurs:

    - The Federal Reserve, OCC, or FDIC issues genAI-specific MRM guidance (filling the SR 26-2 / OCC 2026-13 exclusion), **or**
    - **2027-Q1**, whichever comes first, to ensure forward motion if agency action is delayed.

    Until 3.8a lands, organizations should treat 3.8 as the operative interim control and monitor agency communications. The framework's regulatory monitor (`scripts/regulatory_monitor.py`) tracks Federal Register publications from these agencies; for supervisory guidance issued outside the Federal Register (SR letters, OCC bulletins), watch [federalreserve.gov/supervisionreg/srletters.htm](https://www.federalreserve.gov/supervisionreg/srletters.htm) and [occ.gov/news-issuances/bulletins](https://www.occ.gov/news-issuances/bulletins/) directly. See GitHub issue [#3](https://github.com/judeper/FSI-CopilotGov/issues/3) for the decision record.
