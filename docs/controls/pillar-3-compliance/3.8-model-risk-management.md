...
**Regulatory Reference:** SR 26-2 / OCC Bulletin 2026-13 (Revised Guidance on Model Risk Management, April 2026 — supersedes SR 11-7 / OCC Bulletin 2011-12 but explicitly excludes generative and agentic AI; Copilot governance therefore continues to apply SR 11-7 / OCC Bulletin 2011-12 principles as the most recent applicable guidance), OCC Bulletin 2025-26 (Model Risk Management — Community Bank Proportionality), ECOA (Equal Credit Opportunity Act), Fair Housing Act
...
> **Regulatory update notice (April 2026):** On **April 17, 2026**, the Federal Reserve, OCC, and FDIC jointly issued **SR 26-2** ([Federal Reserve](https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm)) and **OCC Bulletin 2026-13** ([OCC](https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html)) — *Revised Guidance on Model Risk Management* — which **supersedes SR 11-7 and OCC Bulletin 2011-12**. The revised guidance applies a risk-based approach scaled to institution size and complexity (most relevant to banking organizations with over $30B in total assets) and **explicitly excludes generative and agentic AI models pending further regulatory consideration**. Because Microsoft 365 Copilot is a generative AI system, the operative MRM expectations for Copilot remain undefined under the revised interagency framework; this control therefore continues to map to the SR 11-7 / OCC Bulletin 2011-12 principles as the most recent applicable guidance, supplemented by institution-specific policy. Organizations should monitor for forthcoming agency guidance on generative AI MRM and update their Copilot governance accordingly. See [3.8 Additional Resources](#additional-resources) for SR 26-2 link.

!!! note "Companion control — generative-AI MRM (control 3.8a)"
    Generative-AI–specific governance is provided by the companion control **[3.8a — Generative AI Model Governance](3.8a-generative-ai-model-governance.md)**, which synthesizes the SR 11-7 / OCC Bulletin 2011-12 principles this control applies with genAI-specific frameworks (NIST AI RMF 1.0, ISO/IEC 42001). Because SR 26-2 / OCC Bulletin 2026-13 **explicitly excludes generative and agentic AI**, the operative interagency MRM expectations for Copilot remain undefined; 3.8 and 3.8a are therefore **co-dependent** and should be operated as a single integrated program rather than competing frameworks — 3.8 anchors the legacy MRM baseline while 3.8a supplies the genAI overlay.
...
Align Microsoft 365 Copilot governance with model risk management (MRM) frameworks established under OCC Bulletin 2011-12 and Federal Reserve SR 11-7, including model inventory, validation scope, ongoing monitoring, and documentation -- while recognizing that Microsoft 365 Copilot is a vendor-provided model with limited internal validation scope, and focusing governance on usage controls and output monitoring. Address fair lending and ECOA considerations where Copilot outputs could reflect bias in lending, advisory, or customer service contexts. Apply the proportionality guidance from OCC Bulletin 2025-26 to align MRM depth with the institution's size, complexity, and Copilot usage scope.
...
| 9 | Verify annual comprehensive MRM assessment is completed | Assessment follows SR 11-7 / OCC Bulletin 2011-12 structure and documents findings | Regulated |
