# Control 3.8: Model Risk Management Alignment (SR 26-2 / OCC Bulletin 2026-13, applying SR 11-7 / OCC 2011-12 principles to generative AI)

**Control ID:** 3.8
**Pillar:** Compliance & Audit
**Regulatory Reference:** SR 26-2 / OCC Bulletin 2026-13 (Revised Guidance on Model Risk Management, April 2026 — supersedes SR 11-7 / OCC Bulletin 2011-12 but explicitly excludes generative and agentic AI; firms using historical SR 11-7 / OCC Bulletin 2011-12 principles for Copilot should treat them as an internal-policy reference unless counsel approves a current supervisory-source mapping), OCC Bulletin 2025-26 (Model Risk Management — Community Bank Proportionality), ECOA (Equal Credit Opportunity Act), Fair Housing Act

**Last Verified:** 2026-09-23
**Regulatory Review:** Pending — legal/compliance questions tracked in judeper/OceanSquad#242
**Governance Levels:** Baseline / Recommended / Regulated

---

> **Regulatory update notice (April 2026):** On **April 17, 2026**, the Federal Reserve, OCC, and FDIC jointly issued **SR 26-2** ([Federal Reserve](https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm)) and **OCC Bulletin 2026-13** ([OCC](https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html)) — *Revised Guidance on Model Risk Management* — which **supersedes SR 11-7 and OCC Bulletin 2011-12**. The revised guidance applies a risk-based approach scaled to institution size and complexity (most relevant to banking organizations with over $30B in total assets) and **explicitly excludes generative and agentic AI models pending further regulatory consideration**. Because Microsoft 365 Copilot is a generative AI system, the operative MRM expectations for Copilot remain undefined under the revised interagency framework; firms that continue to use SR 11-7 / OCC Bulletin 2011-12 principles for Copilot should document them as an internal-policy reference unless legal/MRM owners approve a current supervisory-source mapping. Organizations should monitor for forthcoming agency guidance on generative AI MRM and update their Copilot governance accordingly. See [3.8 Additional Resources](#additional-resources) for SR 26-2 link.

!!! note "Companion control — generative-AI MRM (control 3.8a)"
    Generative-AI–specific governance is provided by the companion control **[3.8a — Generative AI Model Governance](3.8a-generative-ai-model-governance.md)**, which pairs historical SR 11-7 / OCC Bulletin 2011-12 principles used as an internal-policy reference with genAI-specific frameworks (NIST AI RMF 1.0, ISO/IEC 42001). Because SR 26-2 / OCC Bulletin 2026-13 **explicitly excludes generative and agentic AI**, the operative interagency MRM expectations for Copilot remain undefined; 3.8 and 3.8a are therefore **co-dependent** and should be operated as a single integrated program rather than competing frameworks — 3.8 anchors the legacy MRM baseline while 3.8a supplies the genAI overlay. Regulatory-source mapping and current supervisory applicability: confirm.

    Continue to monitor for forthcoming agency guidance on generative-AI MRM (which would fill the SR 26-2 / OCC 2026-13 exclusion). The framework's regulatory monitor (`scripts/regulatory_monitor.py`) tracks Federal Register publications from these agencies; for supervisory guidance issued outside the Federal Register (SR letters, OCC bulletins), watch [federalreserve.gov/supervisionreg/srletters.htm](https://www.federalreserve.gov/supervisionreg/srletters.htm) and [occ.gov/news-issuances/bulletins](https://www.occ.gov/news-issuances/bulletins/) directly. See GitHub issue [#3](https://github.com/judeper/FSI-CopilotGov/issues/3) for the decision record. See [3.8 Additional Resources](#additional-resources) for SR 26-2 link.

!!! note "Regulatory applicability"
    Regulatory citations in this section identify commonly referenced requirements. Applicability, model classification, and supervisory-source mapping depend on the firm's regulatory status and approved MRM policy; confirm with counsel. See judeper/OceanSquad#242.

---

## Objective

Align Microsoft 365 Copilot governance with the firm's approved model risk management (MRM) policy, using OCC Bulletin 2011-12 and Federal Reserve SR 11-7 as historical internal-policy references where approved, including model inventory, validation scope, ongoing monitoring, and documentation -- while recognizing that Microsoft 365 Copilot is a vendor-provided model with limited internal validation scope, and focusing governance on usage controls and output monitoring. Address fair lending and ECOA considerations where counsel confirms Copilot outputs intersect with lending, advisory, or customer service contexts. Apply the proportionality guidance from OCC Bulletin 2025-26 as context where approved by legal/MRM owners.
...
Microsoft 365 Copilot presents a unique MRM challenge: it is a general-purpose LLM provided by Microsoft as a vendor service, not a model developed in-house for a specific quantitative purpose. SR 11-7 defines a "model" as "a quantitative method, system, or approach that applies statistical, economic, financial, or mathematical theories, techniques, and assumptions to process input data into quantitative estimates." Copilot straddles this definition — it processes input and produces output, but it is not a traditional quantitative model designed for a specific financial decision. Institutions cannot validate the model's internal architecture, training data, or algorithmic mechanics in the traditional MRM sense. However, institutions can govern how the model is used, monitor its outputs, document its limitations, and implement compensating controls for known risks; regulator-expectation framing: confirm.

**OCC Bulletin 2025-26 proportionality guidance:** In 2025, the OCC issued community-bank model risk management clarification emphasizing flexibility for community banks to tailor validation frequency and scope to risk exposure, business activities, and model-use complexity. OCC Bulletin 2026-13 later superseded/rescinded the 2011 model-risk guidance while citing the community-bank proportionality context. For community banks and smaller institutions deploying Copilot, any simplified MRM approach should be documented as institution policy based on actual usage scope, recognizing that the 2026 revised guidance explicitly excludes generative and agentic AI models. Larger institutions with more complex Copilot deployments (client-facing activities, lending workflows, regulated advisory) should obtain model-risk/legal approval for the applicable internal framework.

The fair lending dimension adds urgency to MRM alignment. If Copilot generates customer communications, assists with lending decisions, or supports advisory activities, its outputs could inadvertently reflect biases relevant to the Equal Credit Opportunity Act (ECOA) or the Fair Housing Act. Approved use cases that participate in credit, housing, advisory, or other regulated decisions and the required monitoring: confirm.

## Control Description

This control addresses the MRM framework alignment for Microsoft 365 Copilot, organized around the three pillars of OCC Bulletin 2011-12: model development (adaptation for vendor models), model validation, and ongoing monitoring.

> **Generative AI scope:** Generative AI–specific governance is addressed by **[Control 3.8a — Generative AI Model Governance](3.8a-generative-ai-model-governance.md)**, which extends this control with NIST AI RMF 1.0, ISO/IEC 42001, and the SR 26-2 / OCC Bulletin 2026-13 generative AI exclusion mappings.

### Copilot's Model Status Under SR 11-7 / OCC Bulletin 2011-12 (interim framework for generative AI)

The foundational question for any institution's MRM program is whether Microsoft 365 Copilot meets the SR 11-7 definition of a "model." Copilot occupies a gray zone: it processes input data and produces output, but it is not a traditional quantitative model built to generate specific financial estimates. One firm policy approach is to register Copilot in the model inventory as a limited-scope or lower-tier model, with governance focused on usage controls, output monitoring, and vendor due diligence rather than the validation infrastructure designed for in-house quantitative models; firms should confirm the classification with legal/MRM owners.

An illustrative approach is to classify Copilot as a **Tier 3 (limited-scope)** model when used primarily for internal productivity (document drafting, meeting summaries, research support), with escalation to **Tier 2** or **Tier 1** when deployed in client-facing, lending, or advisory workflows. This tier assignment should be documented in the model inventory with supporting rationale and confirmed with legal/MRM owners.

### MRM Framework Adaptation for Vendor-Provided LLMs

| Traditional MRM Element | Microsoft 365 Copilot Adaptation |
|------------------------|------------------------|
...
### Model Inventory Entry for Microsoft 365 Copilot
...
| **Risk tier** | Firm-approved example: Tier 3 (limited-scope) for internal productivity; Tier 2 for business unit decision support; Tier 1 for client-facing or lending workflows; confirm tiering with legal/MRM owners |
...
| **Validation frequency** | Firm-approved example: quarterly output review; annual comprehensive assessment; confirm cadence with legal/MRM owners |
...
| **Copilot Notebooks** | Low-Moderate -- collaborative content creation | Low | Content accuracy when used for decision-support documents |

## Governance Levels

### Baseline

Applies to institutions of all sizes, calibrated to actual Copilot usage scope. OCC Bulletin 2025-26 is a community-bank clarification that remains relevant to proportionality and is referenced by OCC Bulletin 2026-13, while OCC Bulletin 2026-13 / Federal Reserve SR 26-2 supersedes and rescinds the 2011 model-risk guidance for traditional models and explicitly excludes generative and agentic AI. Annual validation is not mandatory for community banks solely because a fixed annual cadence was inferred from prior model-risk guidance; any Copilot-specific cadence should be approved as firm policy:

- Register Microsoft 365 Copilot in the enterprise model inventory with tier classification (Tier 3 for internal productivity, with documentation of the proportionality rationale for community banks per OCC Bulletin 2025-26). The AI inventory entry should include: tool name, version, purpose, business owner, deployment date, and risk classification
...
- Document the usage scope and confirm it aligns with the selected model tier, applying the proportionality principle — validation rigor scales with risk complexity and materiality:
    ...
    - **Microsoft 365 Copilot for productivity** (no automated decision-making): Lower-risk; vendor due diligence + AI inventory entry sufficient
...
- Create Copilot-specific model risk documentation that follows the firm's approved structure, using OCC Bulletin 2011-12 as a historical reference where approved, including these example elements:
...
- Leverage Microsoft tools to collect MRM-relevant data:
    - **Microsoft Purview Data Security Posture Management (including DSPM for AI/classic capabilities):** data risk assessments for oversharing, AI app activity reports, sensitive-information findings in prompts/responses where supported, and recommendations/policies such as risky-AI-usage detection — feeds risk assessment
    - **Purview Audit (UAL):** Interaction logs, accessed resources, sensitivity labels on accessed files
    - **Microsoft Defender for Cloud Apps:** discover, monitor, and block generative AI apps, including app catalog/risk-score review and custom policies for Generative AI app usage
...
Firm-approved tier guidance for institutions deploying Copilot in client-facing, lending, or complex financial workflows. Note: For Copilot used solely as a productivity tool with no automated decision-making, annual comprehensive validation is not assumed solely from OCC Bulletin 2025-26; firms should confirm with legal/MRM owners when the regulated tier applies because Copilot outputs materially affect bank decisions, customer communications, or lending activities:

- Conduct annual comprehensive MRM assessment for Copilot aligned with SR 11-7 / OCC Bulletin 2011-12 expectations, including validation report focused on usage controls and output quality (not internal model architecture, which is Microsoft's responsibility as vendor)
...
3. Classify Copilot at the appropriate risk tier based on actual usage scope and the institution's MRM policy — applying OCC Bulletin 2025-26 proportionality where appropriate:
    - **Tier 1 (High):** If Copilot is used in client-facing activities, lending workflows, or financial reporting — full MRM lifecycle applies under the firm's approved MRM framework
    ...
    - **Tier 3 (Low / Limited-scope):** If Copilot usage is limited to non-regulated administrative tasks — model inventory entry with usage scope documentation; community banks with primarily internal Copilot use may apply this tier as firm policy using OCC Bulletin 2025-26 proportionality context
...
Banking regulators increasingly ask about AI and LLM governance during examinations. Institutions should prepare for potential questions about:
...
MRM program depth should scale with usage scope, institutional size, and risk. OCC Bulletin 2025-26 provides community-bank proportionality context; firms should confirm with legal/MRM owners how that context applies to Copilot and whether a community bank using Copilot only for internal meeting summaries and document drafting has different MRM obligations than a large complex banking organization using Copilot to draft lending communications or assist with investment recommendations.

For institutions applying the proportionality principle, the documentation approach should record the usage scope, institution characteristics, and citation (OCC Bulletin 2025-26) supporting the simplified MRM approach. This documentation provides evidence for legal/MRM owner review of the proportionality determination — not an informal decision to skip the MRM framework.
...
The citation currently labeled "2023 Interagency Guidance on AI" from OCC, FDIC, Federal Reserve, NCUA, and CFPB is retained pending source confirmation (source identity pending confirmation). Firms should not treat Copilot as exempt from governance simply because it is a vendor-provided general-purpose tool rather than a purpose-built financial model, and should confirm the applicable MRM framework with legal/MRM owners.
...
| 4 | Verify proportionality determination is documented | OCC Bulletin 2025-26 cited with usage scope and institution characteristics supporting tier selection as a firm policy rationale | Baseline (community banks) |
...
| 9 | Verify annual comprehensive MRM assessment is completed | Assessment follows the firm-approved structure; SR 11-7 / OCC Bulletin 2011-12 may be used as a historical internal-policy reference where approved | Regulated |
...
- [OCC Bulletin 2011-12 rescission status — replaced by OCC Bulletin 2026-13](https://www.occ.gov/news-events/news-and-events-archive/rescinded-issuances/rescinded-occ-bulletins.html)
- [Historical SR 11-7 / OCC 2011-12 model risk management guidance attachment](https://www.federalreserve.gov/boarddocs/srletters/2011/sr1107a1.pdf)
...
- [Federal Reserve SR 26-2 (Revised Guidance on Model Risk Management, April 17, 2026 — supersedes SR 11-7)](https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm)
- [Equal Credit Opportunity Act (ECOA)](https://uscode.house.gov/view.xhtml?edition=prelim&req=granuleid%3AUSC-prelim-title15-chapter41-subchapter4)
- [Fair Housing Act](https://uscode.house.gov/view.xhtml?edition=prelim&path=%2Fprelim%40title42%2Fchapter45)
- [Interagency Guidance on AI (2023) (source identity pending confirmation)](https://www.federalregister.gov/documents/2023/04/13)
...
- **Related Controls:** [3.8a Generative AI Model Governance](3.8a-generative-ai-model-governance.md), [3.7 Regulatory Reporting](3.7-regulatory-reporting.md), [1.10 Vendor Risk Management](../pillar-1-readiness/1.10-vendor-risk-management.md), [3.9 AI Disclosure and Transparency](3.9-ai-disclosure-transparency.md)
