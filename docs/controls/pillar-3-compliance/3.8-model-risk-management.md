...
| **Risk tier** | Firm policy example: Tier 3 (limited-scope) for internal productivity; Tier 2 for business unit decision support; Tier 1 for client-facing or lending workflows; confirm tiering with legal/MRM owners |
...
| **Validation frequency** | Firm policy example: quarterly output review; annual comprehensive assessment; confirm cadence with legal/MRM owners |
...
3. Classify Copilot at the appropriate risk tier based on actual usage scope and the institution's MRM policy — applying OCC Bulletin 2025-26 proportionality where appropriate:
    - **Tier 1 (High):** If Copilot is used in client-facing activities, lending workflows, or financial reporting — full firm-approved MRM lifecycle as applicable
