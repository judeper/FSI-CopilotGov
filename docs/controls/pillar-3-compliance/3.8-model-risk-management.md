...
Applies to institutions of all sizes, calibrated to actual Copilot usage scope per OCC Bulletin 2025-26 proportionality guidance:

- Register M365 Copilot in the enterprise model inventory with tier classification (Tier 3 for internal productivity, with documentation of the proportionality rationale for community banks per OCC Bulletin 2025-26)
- Document Copilot's intended uses and prohibited uses within the institution
- Document the usage scope and confirm it aligns with the selected model tier
...
- Create Copilot-specific model risk documentation that follows OCC Bulletin 2011-12 structure
...
Applies the full OCC Bulletin 2011-12 / SR 11-7 MRM lifecycle for institutions deploying Copilot in client-facing, lending, or complex financial workflows:
