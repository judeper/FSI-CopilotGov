...
!!! note "Regulatory anchor from FINRA Notice 26-14 (request for comment)"
    [FINRA Regulatory Notice 26-14](https://www.finra.org/rules-guidance/notices/26-14) (comment period closes **2026-09-11**) states that GenAI communication tools may be included in a reasonably designed supervisory system when firms vet, test, and continuously monitor those tools, including hallucination and data-protection risk governance. This notice is a request for comment and is not an effective rule; current Rule 2210 controls remain in force while this control uses the notice language as an interim governance anchor for monitoring design.
...
- **Change management** depends on Microsoft's release cadence. Institutions should track Message Center entries, Copilot release notes, the Microsoft AI at Work Roadmap, and Microsoft's model-version disclosures, and re-validate output quality after material model updates.
...
| **Third-party model providers (Anthropic as Microsoft subprocessor; Anthropic Data Retention models and SpaceXAI as independent-processor paths)** | Vendor due diligence overlay; explicit provider-category and data-boundary review (standard Anthropic models are out of EU Data Boundary scope; Data Retention models and SpaceXAI processing sit outside Microsoft contractual data protections) | Clause 8 (operational), Clause 5 (leadership), Annex A vendor controls | High |
| **Microsoft Scout (Frontier preview)** — third-party inference path | Vendor due diligence overlay for the **GitHub Copilot and third-party model providers** that process some Scout inference under their separate terms and outside the Microsoft 365 DPA. Applies NIST AI RMF Manage and ISO/IEC 42001 Clause 8 supplier controls to the Scout-specific inference path. | Clause 8 (operational), Clause 5 (leadership), Annex A vendor and supplier controls | High (preview) — see [Control 4.16](../pillar-4-operations/4.16-microsoft-scout-governance.md) |
...
- Record the date and outcome of the most recent Microsoft Message Center, Copilot release notes, and AI at Work Roadmap review affecting Copilot capabilities.
...
- Conduct an annual vendor due diligence refresh covering Microsoft's Responsible AI updates, third-party model providers in scope, and any newly disclosed safety reports. The refresh should explicitly cover:
    ...
    - **Anthropic models with Data Retention** — independent-processor model category requiring separate Anthropic terms, explicit tenant opt-in, user/group assignment, and retention-risk review. Do not treat enablement of standard Anthropic subprocessor models as approval for this category.
    - **SpaceXAI (xAI)** — independent provider (currently scoped to Copilot Studio); processing occurs outside Microsoft-managed environments and is governed by xAI's separate Enterprise Terms of Service and Data Processing Addendum. The Microsoft Product Terms, DPA, data residency commitments, audit and compliance requirements, SLAs, and Customer Copyright Commitment **do not apply** to SpaceXAI usage. Treat SpaceXAI as a discrete vendor under Control 1.10. *(Provider terms verified against [connect-to-ai-subprocessor](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor) and [connect-to-ai-models](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-models) on 2026-09-22; re-verify before relying, as default state and availability change over time.)*
...
1. Refresh the Microsoft vendor file: latest Responsible AI Standard, transparency notes for Copilot surfaces in scope, model cards (including any third-party model cards relevant when Anthropic or SpaceXAI models are enabled), SOC 2 Type II, Data Protection Addendum.
2. Document the date of refresh, reviewer, and any open questions. Capture provider-specific posture: **standard Anthropic models** (Microsoft subprocessor since Jan 7, 2026; out of scope for EU Data Boundary and in-country LLM processing commitments; on by default outside EU/EFTA/UK), **Anthropic models with Data Retention** (independent-processor model category under separate Anthropic terms), and **SpaceXAI** (independent provider, processing outside Microsoft-managed environments under xAI's separate Enterprise Terms of Service / DPA; Microsoft data residency commitments and Customer Copyright Commitment do not apply).
...
- Firms should confirm with legal, compliance, and model-risk owners which existing risk-management frameworks they apply to generative AI; 3.8a provides a Copilot-specific governance overlay where approved.
...
- [Connect to Anthropic models — Microsoft 365 Copilot (subprocessor scope, EU/EFTA/UK exclusions)](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor)
- [Connect to xAI models — Microsoft 365 Copilot (independent provider; processing outside Microsoft-managed environments)](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-models)
