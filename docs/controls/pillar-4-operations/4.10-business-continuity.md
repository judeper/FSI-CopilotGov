...
**Regulatory Reference:** FFIEC Business Continuity Management Handbook, 12 CFR part 30, appendix D (OCC Heightened Standards), FINRA Rule 4370, GLBA §501(b)
...
| Microsoft 365 Status Page | status.cloud.microsoft | Continuous |

## Copilot Surface Coverage

| Surface | BC/DR Priority | Fallback Complexity |
|---------|---------------|-------------------|
| Microsoft 365 Copilot Chat | Medium | Low -- users revert to standard search |
...
- [Microsoft 365 Service Communications API](https://learn.microsoft.com/en-us/graph/api/resources/service-communications-api-overview)
...
- **Implementation Playbooks:** [Portal Walkthrough](../../playbooks/control-implementations/4.10/portal-walkthrough.md) · [PowerShell Setup](../../playbooks/control-implementations/4.10/powershell-setup.md) · [Verification](../../playbooks/control-implementations/4.10/verification-testing.md) · [Troubleshooting](../../playbooks/control-implementations/4.10/troubleshooting.md)

- **Related Controls:** [4.9 Incident Reporting](4.9-incident-reporting.md), [4.1 Admin Settings and Feature Management](4.1-admin-settings-feature-management.md), [1.10 Vendor Risk Management](../pillar-1-readiness/1.10-vendor-risk-management.md), [4.12 Change Management for Rollouts](4.12-change-management-rollouts.md)
