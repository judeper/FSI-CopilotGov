...
| Copilot Cowork (GA June 2026) | Usage-based billing on Copilot Credits | Model responses, tools/skills, image generation, and browser tasks consume Copilot Credits; visible in Copilot > Cost management. See [Control 4.15](4.15-copilot-cowork-governance.md). |
| Microsoft Scout (Frontier preview) | **Not part of the standard M365 Copilot license cost surface.** Per-user **GitHub Copilot Business or Enterprise** entitlement is required and is billed through GitHub, outside M365 Cost Management. | Include the linked-GitHub-account reconciliation in the cost inventory; see [Control 4.16](4.16-microsoft-scout-governance.md). |
