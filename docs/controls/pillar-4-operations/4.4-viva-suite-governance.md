...
- **Viva Goals** was retired by Microsoft on December 31, 2025. Organizations that previously tracked compliance targets, risk metrics, or regulatory program milestones in Viva Goals should migrate to alternative OKR tracking solutions.
...
**AI-Powered Skill Inferencing:** [People Skills](https://learn.microsoft.com/en-us/microsoft-365/copilot/people-skills-manage-skills-library) uses work activity to infer and update professional skills. Inferencing is on by default for Copilot and Viva users. After People Skills is set up, admins can enable it tenant-wide for Microsoft 365 E3/E5 users; that expansion is off by default and requires the tenant to have at least one Microsoft Copilot license. Manage it in the Microsoft 365 admin center under **Copilot > Settings > Data access > People Skills in Microsoft Copilot**. For FSI environments, evaluate the feature against employee privacy obligations under GLBA and applicable state privacy laws before changing the setting. Organizations should assess whether skill inference processing is covered by existing employee privacy notices and acceptable use policies. See also [Control 3.10 — SEC Reg S-P Privacy](../pillar-3-compliance/3.10-sec-reg-sp-privacy.md).
...
- [Viva Insights Admin Settings](https://learn.microsoft.com/en-us/viva/insights/advanced/setup-maint/setup-overview)
- [Microsoft Viva Engage Overview](https://learn.microsoft.com/en-us/viva/engage/overview)
- [Microsoft Viva Learning](https://learn.microsoft.com/en-us/viva/learning/overview-viva-learning)
- [Microsoft Viva Pulse](https://learn.microsoft.com/en-us/viva/pulse/introduction-to-viva-pulse)
