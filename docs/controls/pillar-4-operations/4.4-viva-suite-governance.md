...
Establish governance controls for Microsoft Copilot across the Viva suite -- including Viva Insights/Copilot Analytics, Viva Engage, Viva Learning, Viva Pulse, and Viva Glint where deployed -- to address employee privacy protections, data aggregation limits, manager access boundaries, and appropriate use of AI-driven workforce analytics within regulated financial services environments.

!!! warning "Viva Goals Retirement"
    Microsoft retired Viva Goals on December 31, 2025. All Viva Goals references in this control have been removed. Organizations that previously used Viva Goals for OKR tracking should migrate to alternative solutions. See [Microsoft Viva Goals retirement announcement](https://learn.microsoft.com/en-us/viva/goals/goals-retirement).
...
- **Viva Learning / Learning Agent** can surface role-specific learning recommendations, AI and Copilot skilling content, and enterprise learning content. It should supplement, not replace, authoritative compliance-training systems.
- **Viva Pulse and Viva Glint** collect employee feedback and sentiment. Copilot features can summarize reports or comments when licensing, access, and confidentiality thresholds are met; these summaries require human review before management action.
- **Viva Goals** was retired by Microsoft on December 31, 2025. Organizations that previously tracked compliance targets, risk metrics, or regulatory program milestones in Viva Goals should retain/export historical evidence and migrate to alternative OKR tracking solutions.
...
| Copilot Dashboard / Copilot Analytics | Readiness, adoption, impact, sentiment, agent, consumption, and advanced reporting surfaces depending on licensing and tenant eligibility | Aggregated/group-level reporting, role-gated access, and tenant-specific feature availability |

**Copilot Chat Analytics in Viva Insights**

Viva Insights now anchors **Copilot Analytics**, which includes the Copilot Dashboard, Agent Dashboard, Consumption Dashboard, Advanced Reporting, and Power BI templates. Copilot Chat and Microsoft Copilot insights deliver organizational visibility into AI-assisted work, including:
...
- **Interaction frequency and prompt metrics:** active users, prompts submitted, active days, and workload-level activity depending on the report surface
- **Impact and sentiment views:** dashboard impact pages, Viva Pulse or Viva Glint sentiment data where licensed and configured, and optional business impact reporting where the firm uploads outcome data
- **Agent and consumption views:** Agent Dashboard and Consumption Dashboard availability depends on licensing, activity, and roadmap rollout; verify in the tenant
...
From an FSI governance perspective, Copilot Analytics can provide evidence that the firm monitors AI adoption and usage patterns. Treat this as internal governance evidence, not as a conclusion that any regulatory requirement is met. Unusual usage patterns — such as elevated off-hours activity, rapid agent adoption, or unexpected usage concentration — can be routed for compliance review when the Regulated tier monitoring configuration is approved.
...
**~~Viva Goals Copilot Governance~~ (Retired)**

!!! warning "Product Retired"
    Microsoft retired Viva Goals on December 31, 2025. The Copilot features described below are no longer available. Organizations should remove Viva Goals from their governance scope and migrate OKR tracking to alternative solutions.
...
| Viva Learning / Learning Agent | Tenant-dependent | Role-specific learning recommendations, AI/Copilot resources, and enterprise learning content |
| Viva Pulse / Viva Glint | Tenant-dependent | Copilot impact surveys, report summarization, comment summarization, and dashboard sentiment integrations where licensed and thresholds are met |
...
- [ ] Document which Viva suite features have Copilot enabled and for which user groups — per-app Copilot capabilities:
    ...
    |----------|-----------------|-------------|-------------|
    | **Insights / Copilot Analytics** | Copilot Dashboard, Agent Dashboard, Consumption Dashboard, Advanced Reporting, Power BI templates | Viva Insights web app / M365 Admin Center > Viva > Viva Insights | Verify in tenant |
    | **Engage** | Microsoft Copilot assistant across communities, storylines, campaigns, and conversations; legacy Engage Copilot v1 deprecates the week of September 24, 2026 | M365 Admin Center > Copilot settings / Viva Engage Admin Center | `VivaEngage` where present |
    | **Learning / Learning Agent** | AI and Copilot resources, role-specific recommendations, learning agent experiences | Viva Learning Admin tab / Learning Agent | Verify in tenant |
    | **Pulse / Glint** | Copilot impact surveys, Pulse report summaries, Glint highlights/comment summarization where licensed | Viva feature access management / Viva Pulse / Viva Glint | Verify in tenant |
...
- [ ] Enable and review Copilot Analytics surfaces to establish baseline adoption visibility — **Dashboard:** Viva Insights web app > Copilot Dashboard; **Graph API:** use documented Microsoft Copilot reports such as `GET /reports/getMicrosoft365CopilotUsageUserDetail(period='D30')` or `/copilot/reports/getMicrosoft365CopilotUsageUserDetail(period='D30',version='v1')` as applicable.
...
- [ ] Integrate approved Copilot Analytics data with compliance monitoring workflows, including alerts for unusual patterns such as elevated off-hours activity or unexpected usage concentration — use documented Microsoft Copilot usage reports/APIs and verify population coverage in the tenant
...
### Step 1b: Configure Copilot Analytics in Viva Insights

Navigate to the **Viva Insights web app > Copilot Dashboard** and the relevant admin settings:

1. Validate feature availability against assigned licenses:
   - The dashboard is viewable for Microsoft 365 or Office 365 business/enterprise customers with Exchange Online, but features depend on assigned Copilot and Viva Insights license counts.
   - Tenants with 1-49 Copilot licenses receive readiness, adoption/impact, Microsoft Copilot, and Copilot Chat insights; tenants with 50+ Copilot licenses or 50+ Viva Insights licenses receive additional features such as benchmarks, intelligent summaries, group-level manager views, Agent Dashboard, and survey data where available.
2. Configure dashboard access and minimum group size in the admin settings.
3. Configure organizational attributes only when needed for governance analysis.
4. If using Advanced Reporting, assign the Insights Analyst role and document which Copilot metrics and business outcome data are approved for use.
5. Verify in the tenant whether Agent Dashboard, Consumption Dashboard, Viva Pulse, or Viva Glint integrations are available before relying on them.
...
### Step 4: Configure Viva Pulse and Viva Glint Privacy

1. Set minimum response or confidentiality thresholds for Viva Pulse and Viva Glint reports.
2. Configure anonymity settings to prevent identification of individual respondents.
3. Establish a review process for Copilot-generated survey questions, Pulse report summaries, Glint highlights, and comment summaries before management action.
4. Document data retention and access for Pulse/Glint survey responses and summaries.

## Financial Sector Considerations

**Copilot Analytics and Regulatory Monitoring:** Copilot Analytics can support internal technology-usage monitoring by providing aggregated, privacy-preserving visibility into AI tool adoption across the organization. Compliance and audit teams should present this as governance evidence, not as a conclusion that any regulatory requirement is satisfied.
...
**AI-Powered Skill Inferencing:** Microsoft now offers AI-powered skill updates for user profiles using Microsoft Graph activity data (February 2026). When enabled, the system processes employee work activity to infer and publish professional skills. For FSI environments, this feature should be evaluated against employee privacy obligations under GLBA and applicable state privacy laws before enablement. Organizations should assess whether skill inference processing is covered by existing employee privacy notices and acceptable use policies. See also [Control 3.10 — SEC Reg S-P Privacy](../pillar-3-compliance/3.10-sec-reg-sp-privacy.md).
...
- [Microsoft Viva Insights - Privacy and Data Protection](https://learn.microsoft.com/en-us/viva/insights/advanced/privacy/privacy)
...
- [Introduction to Microsoft Copilot in Microsoft Viva](https://learn.microsoft.com/viva/copilot/viva-copilot-overview)
- [Set up Microsoft Copilot in Viva Engage](https://learn.microsoft.com/viva/engage/configure-microsoft-365-copilot-in-viva-engage)
- [Viva Goals retirement](https://learn.microsoft.com/viva/goals/goals-retirement)
- [Learning Agent overview](https://learn.microsoft.com/viva/learning/learning-agent-overview)
- [Set up Microsoft Copilot in Viva Pulse](https://learn.microsoft.com/viva/pulse/copilot-in-pulse/configure-copilot-in-pulse)
- [Measure Microsoft Copilot impact with Viva Pulse](https://learn.microsoft.com/viva/pulse/viva-integrations/measure-copilot-impact-in-your-organization)
- [Introduction to Microsoft Copilot in Viva Glint](https://learn.microsoft.com/viva/glint/copilot/copilot-admin-intro)
- [EEOC Guidance on AI in Employment](https://www.eeoc.gov/newsroom/eeoc-launches-initiative-artificial-intelligence-and-algorithmic-fairness) (original initiative announcement; detailed technical guidance documents were withdrawn in January 2025 — underlying anti-discrimination laws remain in effect)
...
- **Implementation Playbooks:** [Portal Walkthrough](../../playbooks/control-implementations/4.4/portal-walkthrough.md) · [PowerShell Setup](../../playbooks/control-implementations/4.4/powershell-setup.md) · [Verification](../../playbooks/control-implementations/4.4/verification-testing.md) · [Troubleshooting](../../playbooks/control-implementations/4.4/troubleshooting.md)
