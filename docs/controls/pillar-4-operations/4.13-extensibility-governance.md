...
- **Auditability and lineage:** Multi-agent chains may obscure the origin and transformation of data in Copilot responses. For FSI environments subject to model risk management (SR 11-7 / OCC Bulletin 2011-12 / [Control 3.8](../pillar-3-compliance/3.8-model-risk-management.md)), organizations should verify that Purview audit logs capture the full execution chain including which agents participated.
