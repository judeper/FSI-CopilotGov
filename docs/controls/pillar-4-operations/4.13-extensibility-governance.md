...
- **Auditability and lineage:** Multi-agent chains may obscure the origin and transformation of data in Copilot responses. For FSI environments subject to model risk management (OCC SR 11-7 / [Control 3.8](../pillar-3-compliance/3.8-model-risk-management.md)), organizations should verify that Purview audit logs capture the full execution chain including which agents participated.
