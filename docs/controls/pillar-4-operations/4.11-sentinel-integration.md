...
|---------------|----------------|---------------|
| Microsoft 365 (Office 365) | Copilot audit events in Unified Audit Log | Enable Office 365 connector in Sentinel |
...
| Microsoft 365 Defender | Threat signals correlated with Copilot usage | Enable M365 Defender connector |
...
- [ ] Enable the Microsoft 365 (Office 365) data connector in Sentinel
...
|---|------------------|-----------------|
| 1 | Verify Sentinel data connectors are active and ingesting Copilot events | Data flowing from Office 365, Entra ID, and Purview connectors |
