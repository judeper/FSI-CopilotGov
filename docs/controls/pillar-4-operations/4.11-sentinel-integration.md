...
<!-- NEEDS_HUMAN_REVIEW: Verify CopilotActivity table availability and schema in your Sentinel environment. If the dedicated Copilot data connector (preview) is not enabled, Agent 365 events may appear in the OfficeActivity table instead. -->
