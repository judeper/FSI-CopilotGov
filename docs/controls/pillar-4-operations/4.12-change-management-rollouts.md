...
| **Copilot Studio release notes** | [Copilot Studio release notes](https://learn.microsoft.com/en-us/power-platform/release-plan/2026wave1/microsoft-copilot-studio/) | Monthly | Track agent platform changes that affect [Control 4.14](4.14-copilot-studio-agent-lifecycle.md) |
| **Microsoft Purview what's new** | [What's new in Microsoft Purview](https://learn.microsoft.com/purview/whats-new) | Monthly | Identify changes to compliance controls (DLP, retention, eDiscovery, Communication Compliance) |
...
Institutions operating in GCC or GCC High environments should verify feature availability against the [Microsoft 365 Government feature comparison](https://learn.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government) because Copilot features may launch in commercial tenants weeks or months before government clouds.
