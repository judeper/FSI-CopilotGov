...
3. For automated monitoring, use the **Service Communications API**:
   - Microsoft Graph API endpoint: `https://graph.microsoft.com/v1.0/admin/serviceAnnouncement/messages`
...
- [FFIEC IT Examination Handbook - Development and Acquisition](https://ithandbook.ffiec.gov/it-booklets/development-and-acquisition/)
