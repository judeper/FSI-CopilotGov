...
In addition to Message Center, Microsoft publishes Copilot changes through product release notes, what's-new pages, and the Microsoft 365 Roadmap. These sources often provide more detailed feature context than Message Center posts and may announce changes before or after the corresponding MC post.
...
| **Microsoft 365 Roadmap — Copilot filter** | [Microsoft 365 Roadmap](https://www.microsoft.com/microsoft-365/roadmap) filtered to Copilot | Monthly | Identify upcoming features that may require pre-deployment governance review |
...
| **Microsoft 365 Admin Center release notes** | M365 Admin Center > Settings > Release notes | Weekly | Review admin-facing changes alongside Message Center posts |
