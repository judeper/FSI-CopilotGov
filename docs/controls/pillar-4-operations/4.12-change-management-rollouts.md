...
|--------|---------------|-------------------|------------|
| **Microsoft 365 Copilot what's new** | [What's new in Microsoft 365 Copilot](https://learn.microsoft.com/copilot/microsoft-365/microsoft-365-copilot-overview-whats-new) | Weekly | Review for new features affecting governance controls |
...
| **Copilot Studio release notes** | [Copilot Studio release notes](https://learn.microsoft.com/microsoft-copilot-studio/release-notes) | Monthly | Track agent platform changes that affect [Control 4.14](4.14-copilot-studio-agent-lifecycle.md) |
