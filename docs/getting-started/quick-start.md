...
4. Enable **Restricted SharePoint Search** during assessment if broad exposure is found — this limits Copilot's BizChat grounding to a curated list of up to 100 SharePoint sites while you remediate
