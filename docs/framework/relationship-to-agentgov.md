...
| **Controls** | {{ counts.controls }} | 71 |
| **Playbooks** | {{ counts.playbooks_total }} ({{ counts.playbooks_control }} control + {{ counts.playbooks_cross_cutting }} cross-cutting) | 284 (4 per control) |
...
| **Framework version** | v1.8.0 | v1.2.42 |
...
|  |  / Regulated               |  |                             |  |
|  |                             |  |  Governance model:          |  |
|  |  {{ counts.controls }} controls, {{ counts.playbooks_total }} playbooks    |  |  Zone 1 / 2 / 3            |  |
