...
- **Objective:** Verify CA policies are ready for the June 15, 2026 baseline-scopes enforcement change
- **Steps:**
...
- **Expected Result:** No unremediated "All resources + Copilot exclusion" policies as the rollout reaches the tenant
...
| June 2026 baseline-scopes remediation documentation | PDF | Compliance evidence repository | 7 years |
...
|-----------|-------------|------------------------------|
| NYDFS Part 500 §500.12 | MFA for external network access | MFA requirement ensures Copilot access from outside corporate network requires MFA; the June 2026 baseline-scopes enforcement closes the "All resources + exclusion" bypass path |
