...
- **Resolution:**
  ...
  4. Confirm the `CopilotAgentManagement` record type (RecordType 384 in the AuditLogRecordType enum) is available in your tenant by checking the Microsoft 365 Admin Center under Service features.
