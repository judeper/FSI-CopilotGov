...
|---------|------|-----------|
| 1.1 | Copilot Readiness Assessment and Data Hygiene | [Portal](1.1/portal-walkthrough.md) / [PowerShell](1.1/powershell-setup.md) / [Verification](1.1/verification-testing.md) / [Troubleshooting](1.1/troubleshooting.md) |
| 1.2 | SharePoint Oversharing Detection (DSPM for AI) | [Portal](1.2/portal-walkthrough.md) / [PowerShell](1.2/powershell-setup.md) / [Verification](1.2/verification-testing.md) / [Troubleshooting](1.2/troubleshooting.md) |
| 1.3 | Restricted SharePoint Search Configuration | [Portal](1.3/portal-walkthrough.md) / [PowerShell](1.3/powershell-setup.md) / [Verification](1.3/verification-testing.md) / [Troubleshooting](1.3/troubleshooting.md) |
| 1.4 | Semantic Index Governance | [Portal](1.4/portal-walkthrough.md) / [PowerShell](1.4/powershell-setup.md) / [Verification](1.4/verification-testing.md) / [Troubleshooting](1.4/troubleshooting.md) |
| 1.5 | Sensitivity Label Taxonomy Review | [Portal](1.5/portal-walkthrough.md) / [PowerShell](1.5/powershell-setup.md) / [Verification](1.5/verification-testing.md) / [Troubleshooting](1.5/troubleshooting.md) |
| 1.6 | Permission Model Audit | [Portal](1.6/portal-walkthrough.md) / [PowerShell](1.6/powershell-setup.md) / [Verification](1.6/verification-testing.md) / [Troubleshooting](1.6/troubleshooting.md) |
| 1.7 | SharePoint Advanced Management Readiness | [Portal](1.7/portal-walkthrough.md) / [PowerShell](1.7/powershell-setup.md) / [Verification](1.7/verification-testing.md) / [Troubleshooting](1.7/troubleshooting.md) |
| 1.8 | Information Architecture Review | [Portal](1.8/portal-walkthrough.md) / [PowerShell](1.8/powershell-setup.md) / [Verification](1.8/verification-testing.md) / [Troubleshooting](1.8/troubleshooting.md) |
| 1.9 | License Planning and Assignment Strategy | [Portal](1.9/portal-walkthrough.md) / [PowerShell](1.9/powershell-setup.md) / [Verification](1.9/verification-testing.md) / [Troubleshooting](1.9/troubleshooting.md) |
| 1.10 | Vendor Risk Management for Microsoft AI Services | [Portal](1.10/portal-walkthrough.md) / [PowerShell](1.10/powershell-setup.md) / [Verification](1.10/verification-testing.md) / [Troubleshooting](1.10/troubleshooting.md) |
...
| Control | Name | Playbooks |
|---------|------|-----------|
| 2.1 | DLP Policies for M365 Copilot Interactions | [Portal](2.1/portal-walkthrough.md) / [PowerShell](2.1/powershell-setup.md) / [Verification](2.1/verification-testing.md) / [Troubleshooting](2.1/troubleshooting.md) |
| 2.2 | Sensitivity Labels and Copilot Content Classification | [Portal](2.2/portal-walkthrough.md) / [PowerShell](2.2/powershell-setup.md) / [Verification](2.2/verification-testing.md) / [Troubleshooting](2.2/troubleshooting.md) |
| 2.3 | Conditional Access Policies for Copilot Workloads | [Portal](2.3/portal-walkthrough.md) / [PowerShell](2.3/powershell-setup.md) / [Verification](2.3/verification-testing.md) / [Troubleshooting](2.3/troubleshooting.md) |
| 2.4 | Information Barriers for Copilot (Chinese Wall) | [Portal](2.4/portal-walkthrough.md) / [PowerShell](2.4/powershell-setup.md) / [Verification](2.4/verification-testing.md) / [Troubleshooting](2.4/troubleshooting.md) |
| 2.5 | Data Minimization and Grounding Scope | [Portal](2.5/portal-walkthrough.md) / [PowerShell](2.5/powershell-setup.md) / [Verification](2.5/verification-testing.md) / [Troubleshooting](2.5/troubleshooting.md) |
| 2.6 | Copilot Web Search and Web Grounding Controls | [Portal](2.6/portal-walkthrough.md) / [PowerShell](2.6/powershell-setup.md) / [Verification](2.6/verification-testing.md) / [Troubleshooting](2.6/troubleshooting.md) |
| 2.7 | Data Residency and Cross-Border Data Flow | [Portal](2.7/portal-walkthrough.md) / [PowerShell](2.7/powershell-setup.md) / [Verification](2.7/verification-testing.md) / [Troubleshooting](2.7/troubleshooting.md) |
| 2.8 | Encryption (Data in Transit and at Rest) | [Portal](2.8/portal-walkthrough.md) / [PowerShell](2.8/powershell-setup.md) / [Verification](2.8/verification-testing.md) / [Troubleshooting](2.8/troubleshooting.md) |
| 2.9 | Defender for Cloud Apps — Copilot Session Controls | [Portal](2.9/portal-walkthrough.md) / [PowerShell](2.9/powershell-setup.md) / [Verification](2.9/verification-testing.md) / [Troubleshooting](2.9/troubleshooting.md) |
| 2.10 | Insider Risk Detection for Copilot Usage | [Portal](2.10/portal-walkthrough.md) / [PowerShell](2.10/powershell-setup.md) / [Verification](2.10/verification-testing.md) / [Troubleshooting](2.10/troubleshooting.md) |
| 2.11 | Copilot Pages Security and Sharing Controls | [Portal](2.11/portal-walkthrough.md) / [PowerShell](2.11/powershell-setup.md) / [Verification](2.11/verification-testing.md) / [Troubleshooting](2.11/troubleshooting.md) |
| 2.12 | External Sharing and Guest Access Governance | [Portal](2.12/portal-walkthrough.md) / [PowerShell](2.12/powershell-setup.md) / [Verification](2.12/verification-testing.md) / [Troubleshooting](2.12/troubleshooting.md) |
...
1. **Start with Portal Walkthrough** to understand what needs to be configured and where
2. **Use PowerShell Setup** to automate configuration at scale and create repeatable deployments
3. **Run Verification and Testing** to validate controls are working and collect evidence
4. **Reference Troubleshooting** when issues arise during implementation or operation
