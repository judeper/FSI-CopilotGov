...
Test cases and evidence collection procedures to validate communication compliance monitoring for Copilot-assisted communications.
...
- **Steps:**
  ...
  4. Verify all required locations (Exchange, Teams, Copilot) are enabled.
...
### Test 4: Trainable Classifier Accuracy
...
|-----------|-------------|----------------------|
| FINRA 3110 | Supervisory review of communications | Supports compliance with supervision requirements for AI-assisted communications |
