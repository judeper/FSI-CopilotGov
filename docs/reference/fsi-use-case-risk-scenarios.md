...
**Regulatory references:** Bank Secrecy Act (BSA), FinCEN guidance, OCC/Fed model risk management guidance (see [Control 3.8](../controls/pillar-3-compliance/3.8-model-risk-management.md))
...
| **Model risk** | AI-assisted investment analysis is subject to OCC/Fed model risk management guidance | [3.8 Model Risk Management](../controls/pillar-3-compliance/3.8-model-risk-management.md) |
...
**Regulatory references:** FINRA Rule 5280, FINRA Rule 2241/2242, OCC/Fed model risk management guidance (see [Control 3.8](../controls/pillar-3-compliance/3.8-model-risk-management.md))
