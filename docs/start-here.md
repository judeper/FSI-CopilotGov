...
!!! tip "Ready to assess your current posture?"
    Once you've reviewed the controls, use the [Governance Scorecard](assessment/index.md) to score your organization across all {{ counts.controls }} controls, identify gaps, and generate a prioritized remediation roadmap.
...
| **[Controls](controls/index.md)** | What specific configurations are required and why — {{ counts.controls }} controls across {{ counts.pillars }} lifecycle pillars | Security engineers, M365 admins |
