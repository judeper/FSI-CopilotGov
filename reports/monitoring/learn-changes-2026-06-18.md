...
**Run Date:** 2026-06-18
**Run Time:** 2026-06-18T12:45:29.445418+00:00
...
|---|-----|----------------|-------------------|-----------------|
| 1 | microsoft-365-copilot-usage | HIGH | 4.5 | Review and update |
| 2 | release-notes | CRITICAL | 4.12 | Monitor |
| 3 | whats-new | CRITICAL | 4.12 | Monitor |
| 4 | connect-to-ai-subprocessor | HIGH | 3.8a, 2.7 | Review and update |
| 5 | dlp-policy-reference | HIGH | None | Review and update |
| 6 | ...osoft365-copilot-location-learn-about | HIGH | 2.1 | Review and update |
| 7 | apply-sensitivity-label-automatically | HIGH | 1.5, 2.2 | Review and update |
| 8 | audit-log-activities | HIGH | 1.15 | Review and update |
| 9 | create-retention-policies | HIGH | 3.2 | Review and update |
| 10 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 11 | purview-management | HIGH | None | Review and update |
| 12 | ...m/en-us/microsoft-365/copilot/cowork/ | HIGH | None | Review and update |
| 13 | get-started | HIGH | None | Review and update |
| 14 | cowork-admin-governance | HIGH | None | Review and update |
| 15 | cowork-manage-plugins | HIGH | None | Review and update |
| 16 | cowork-faq | HIGH | None | Review and update |
| 17 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, 2.1, index | Review optional |
| 18 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.14, 2.16, 2.13 | Review and update |
| 19 | overview-copilot-connector | MEDIUM | 2.13 | Review optional |
| 20 | authoring-ask-a-question | HIGH | None | Review and update |
| 21 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 22 | agent-registry | MEDIUM | 4.13, 2.14 | Review optional |
| 23 | ...n.microsoft.com/en-us/entra/agent-id/ | MEDIUM | 2.17 | Review optional |
| 24 | whats-new-agent-id | MEDIUM | None | Review optional |
| 25 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 26 | configure-third-party-agents | MEDIUM | None | Review optional |
| 27 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 28 | concept-risky-agents | HIGH | None | Review and update |
| 29 | agent-id-governance-overview | MEDIUM | None | Review optional |
| 30 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 31 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 32 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 33 | content-governance-agent | HIGH | 1.7 | Review and update |
| 34 | zero-trust-microsoft-365-copilot | HIGH | None | Review and update |
| 35 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 36 | archive-overview | HIGH | 3.2 | Review and update |
...
@@ -1237,6 +1240,9 @@ Logged out of Git provider
 DeletedGitProviderCredentials
 Logged out of Git provider.
...
+Microsoft Fabric Audit activity to retrieve FMI bindings.
 ...
 ModifiedDefaultTier
 Modified OneLake default tier.
@@ -2808,6 +2814,22 @@ User invited
 UserInvited
 Invited user to a folder.
+Organizational Data in Microsoft 365 activities
+The following table lists the activities in Organizational Data in Microsoft 365 that the Microsoft 365 audit log records. For more information about Organizational Data in Microsoft 365, see
+Organizational Data in Microsoft 365
+.
+Friendly name
+Operation
+Description
+Updated data sharing settings
+DataSharingSettingsUpdated
+Logged when a customer updates the list of apps allowed to share data, including which attributes each app can access.
+Updated access policies
+AccessPoliciesUpdated
+Logged when a customer updates access policies that control access to organizational data.
+Updated access policy associations
...
+Logged when a customer updates attribute or app associations to access policies that control access to organizational data.
 ...
 The following table lists the activities in personal insights recorded in the Microsoft 365 audit log. For more information about personal insights, see
 Admin guide for personal insights
@@ -5195,6 +5217,17 @@ Upload folder to blob
 Upload folder to blob
 Compress and upload customer device's fold
```
...
### 18. Conditional Access for agent identities
...
### 19. Identity Protection for agents
...
### 20. Get ready for Copilot with SharePoint Advanced Management
...
### 22. SharePoint Admin Agent (Content Governance Agent)
...
### 23. Zero Trust for Microsoft 365 Copilot
...
### 24. Microsoft Defender for Cloud Apps
...
### 25. Microsoft 365 Archive overview
...
### 4. Microsoft Graph connectors overview
