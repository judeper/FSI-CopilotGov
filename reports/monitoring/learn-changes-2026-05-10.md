...
**Run Date:** 2026-05-10
**Run Time:** 2026-05-10T10:55:05.162159+00:00
...
| 11 | sensitivity-labels-teams-groups-sites | CRITICAL | 2.2 | Monitor |
| 12 | audit-log-activities | HIGH | 1.15 | Review and update |
| 13 | information-barriers-policies | HIGH | None | Review and update |
| 14 | .../microsoft-365/copilot/extensibility/ | HIGH | 1.13, 2.14 | Review and update |
| 15 | manage-copilot-agents-integrated-apps | HIGH | 1.13, 4.1, 4.13, 2.14, 2.13 | Review and update |
| 16 | copilot-tuning-admin-guide | CRITICAL | 1.16 | Monitor |
| 17 | m365-agents-admin-guide | HIGH | None | Review and update |
| 18 | data-connectors-reference | HIGH | None | Review and update |
| 19 | turn-external-sharing-on-or-off | HIGH | None | Review and update |
| 20 | data-access-governance-reports | HIGH | 1.15, 1.1, 1.14, 1.7 | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -1056,9 +1056,15 @@ Planning session upgraded
...
### 9. Get started with information barriers
...
```diff
--- +++ @@ -127,11 +127,15 @@ True
 when you hide or disable user accounts, or when you create a guest. When the organization mode is
 Legacy
-for IB-enabled organizations, these accounts can't communicate with all other user accounts. Administrators can disable this default behavior by manually setting the
+for IB-enabled organizations, IB policies aren't enforced for these accounts in Microsoft Teams. Administrators can change this behavior by manually setting the
 HiddenFromAddressListEnabled
 parameter to
 False
-.
+, which allows IB policy enforcement for these users. When the organization is in
+SingleSegment
+or
+MultiSegment
+mode, IB policies are enforced for hidden users.
 Configuration overview
 Step 1: Make sure prerequisites are met
 : Verify required subscriptions, permissions, directory data for segmenting users, audit logging, IB mode, and Exchange address book policy configuration.

```

---

### 10. Copilot extensibility overview
...
### 16. SAM Content Management Assessment
...
### 17. SharePoint site lifecycle management
...
### 4. Sensitivity labels for Teams, Groups, and sites
