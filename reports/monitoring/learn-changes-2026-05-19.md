...
**Run Date:** 2026-05-19
**Run Time:** 2026-05-19T12:34:25.093809+00:00
...
| 5 | ai-m365-copilot | HIGH | None | Review and update |
| 6 | endpoint-dlp-learn-about | HIGH | None | Review and update |
| 7 | audit-solutions-overview | HIGH | 3.1 | Review and update |
| 8 | audit-search | HIGH | 3.1 | Review and update |
| 9 | audit-log-activities | HIGH | 1.15 | Review and update |
| 10 | cpcn-admin-configuration | HIGH | 2.11 | Review and update |
| 11 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 12 | cpcn-loop-purview-management | HIGH | None | Review and update |
| 13 | cowork-admin-governance | MEDIUM | None | Review optional |
| 14 | concept-conditional-access-policy-common | MEDIUM | None | Review optional |
| 15 | ai-microsoft-purview | HIGH | 1.1, 1.2 | Review and update |
| 16 | .../microsoft-365/copilot/extensibility/ | HIGH | 2.14, 1.13 | Review and update |
| 17 | manage-copilot-agents-integrated-apps | HIGH | 2.13, 2.14, 1.13, 4.1, 4.13 | Review and update |
| 18 | overview-copilot-connector | HIGH | None | Review and update |
| 19 | ...t.com/en-us/microsoft-copilot-studio/ | HIGH | 4.14 | Review and update |
| 20 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 21 | agent-registry | HIGH | 2.14, 4.13 | Review and update |
| 22 | agent-settings | HIGH | 2.13, 2.14, 4.13 | Review and update |
| 23 | agent-registry | MEDIUM | None | Review optional |
| 24 | agents-are-apps | HIGH | None | Review and update |
| 25 | data-privacy-security | MEDIUM | None | Review optional |
| 26 | what-is-microsoft-entra-agent-id | MEDIUM | 2.17 | Review optional |
...
| 30 | agent-id | HIGH | 2.17 | Review and update |
| 31 | concept-risky-agents | MEDIUM | None | Review optional |
| 32 | agent-id-governance-overview | MEDIUM | None | Review optional |
| 33 | concept-secure-web-ai-gateway-agents | MEDIUM | None | Review optional |
| 34 | advanced-management | HIGH | 1.7 | Review and update |
| 35 | data-access-governance-reports | HIGH | 1.1, 1.7, 1.15, 1.14 | Review and update |
| 36 | insights-on-sharepoint-agents | HIGH | None | Review and update |
| 37 | content-management-assessment | HIGH | 1.7 | Review and update |
| 38 | site-lifecycle-management | HIGH | 1.7 | Review and update |
| 39 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 40 | content-governance-agent | HIGH | 1.7 | Review and update |
...
### 12. DSPM for AI (classic) overview
...
### 15. Microsoft Graph connectors overview
...
### 16. Microsoft Copilot Studio documentation
...
### 17. Connect an existing MCP server to an agent
...
@@ -151,52 +162,173 @@ - Selecting the dashboard pane instantly filters the agent list to display only shared agents missing an owner. This feature allows for quick triage and action.
 Real-time updates
...
### 19. Agent settings in Microsoft 365 admin center
...
### 20. Microsoft 365 Copilot agent governance
...
### 21. Conditional Access for agent identities
...
### 22. SharePoint Advanced Management
...
### 23. Data access governance reports
...
### 24. Agent insights report in SharePoint
...
### 25. SAM Content Management Assessment
...
### 26. SharePoint site lifecycle management
