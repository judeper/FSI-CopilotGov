...
**Run Date:** 2026-05-16
**Run Time:** 2026-05-16T10:55:03.089830+00:00
...
| 7 | audit-search | HIGH | 3.1 | Review and update |
| 8 | audit-log-activities | HIGH | 1.15 | Review and update |
| 9 | cpcn-admin-configuration | HIGH | 2.11 | Review and update |
| 10 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 11 | cpcn-loop-purview-management | HIGH | None | Review and update |
| 12 | ai-microsoft-purview | HIGH | 1.1, 1.2 | Review and update |
| 13 | .../microsoft-365/copilot/extensibility/ | HIGH | 2.14, 1.13 | Review and update |
| 14 | overview-copilot-connector | HIGH | None | Review and update |
| 15 | ...t.com/en-us/microsoft-copilot-studio/ | HIGH | 4.14 | Review and update |
| 16 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 17 | agent-registry | HIGH | 2.14, 4.13 | Review and update |
| 18 | agent-settings | HIGH | 2.13, 2.14, 4.13 | Review and update |
| 19 | agent-registry | MEDIUM | None | Review optional |
| 20 | agents-are-apps | HIGH | None | Review and update |
| 21 | data-privacy-security | MEDIUM | None | Review optional |
| 22 | what-is-microsoft-entra-agent-id | MEDIUM | 2.17 | Review optional |
| 23 | what-are-agent-identities | MEDIUM | None | Review optional |
| 24 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 25 | concept-risky-agents | MEDIUM | None | Review optional |
| 26 | agent-id-governance-overview | MEDIUM | None | Review optional |
| 27 | concept-secure-web-ai-gateway-agents | MEDIUM | None | Review optional |
| 28 | advanced-management | HIGH | 1.7 | Review and update |
| 29 | data-access-governance-reports | HIGH | 1.1, 1.7, 1.15, 1.14 | Review and update |
| 30 | insights-on-sharepoint-agents | HIGH | None | Review and update |
| 31 | content-management-assessment | HIGH | 1.7 | Review and update |
| 32 | site-lifecycle-management | HIGH | 1.7 | Review and update |
| 33 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 34 | content-governance-agent | HIGH | 1.7 | Review and update |
...
### 8. Manage Copilot Pages and Notebooks
...
### 11. DSPM for AI (classic) overview
...
### 13. Microsoft Graph connectors overview
...
### 14. Microsoft Copilot Studio documentation
...
### 17. Agent settings in Microsoft 365 admin center
...
### 18. Microsoft 365 Copilot agent governance
...
### 19. SharePoint Advanced Management
...
### 20. Data access governance reports
...
### 21. Agent insights report in SharePoint
...
### 22. SAM Content Management Assessment
...
### 23. SharePoint site lifecycle management
...
### 24. Restricted Content Discovery
...
### 25. SharePoint Admin Agent (Content Governance Agent)
...
### 7. Identity Protection for agents
...
### 9. Network controls for Copilot Studio agents
