...
**Run Date:** 2026-06-05
**Run Time:** 2026-06-05T12:31:29.009288+00:00
...
| 16 | edisc-search-copilot-data | HIGH | 3.3 | Review and update |
| 17 | communication-compliance-policies | CRITICAL | 3.5, 3.4 | Review and update |
| 18 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, index, 2.1 | Review optional |
| 19 | ...curity-posture-management-learn-about | HIGH | 1.14, 3.10 | Review and update |
| 20 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.13, 2.17, 2.16, 2.14 | Review and update |
| 21 | agent-builder-build-agents | HIGH | None | Review and update |
| 22 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 23 | authoring-select-agent-model | HIGH | None | Review and update |
| 24 | overview | HIGH | None | Review and update |
| 25 | agent-365-overview | HIGH | 4.5, 4.13 | Review and update |
| 26 | agent-registry | HIGH | 4.13, 2.14 | Review and update |
| 27 | agent-id | HIGH | 2.17 | Review and update |
| 28 | concept-risky-agents | HIGH | None | Review and update |
| 29 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 30 | ai-in-sharepoint-get-started | MEDIUM | None | Review optional |
| 31 | content-governance-agent | HIGH | 1.7 | Review and update |
| 32 | overview | HIGH | None | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -1622,6 +1622,7 @@ SITs have two different ways of defining the maximum unique instance count parameters. To learn more, see
...
### 10. Search Copilot data in eDiscovery
...
**Affected Controls:**
- Control 3.3: Control 3.3: eDiscovery for Copilot-Generated Content
  - File: `controls/pillar-3-compliance/3.3-ediscovery-copilot-content.md`

**What Changed:**
```diff
--- +++ @@ -137,6 +137,34 @@ condition builder
 .
 Deleting a conversation or message from Microsoft Purview or eDiscovery doesn'tâ¯delete the associated Copilot memory.
+How Copilot interactions appear in eDiscovery results
+Each Microsoft 365 Copilot interaction is stored in the user's Exchange Online mailbox as an individual message-class item (see the
+Data sources for AI data
+table). When these items appear in eDiscovery search results, review sets, or exports (PST files, individual messages, or Microsoft Graph), the email-style headers reflect the two participants of the interaction:
+Interaction direction
+From
+To
+User prompt to Copilot
+The user's primary SMTP address
+The Copilot application identity (for example,
+Microsoft 365 Chat
+,
...
+WebChat
+)
+Copilot response to the user
+The Copilot application identity
+The user's primary SMTP address
+The Copilot application identity is the service-principal display name of the Copilot app that handled the interaction. For example:
+Microsoft 365 Chat
+for Microsoft 365 Copilot Chat (BizChat) interactions.
+The
+host app name
+for in-app Copilot in Word, Excel, PowerPoint, Outlook, OneNote, Loop, and Teams.
+WebChat
+for browser-based Copilot WebChat interactions.
+This identity isn't a routable mailbox and can't receive mail; it identifies the Copilot application that participated in the interaction. This representation is by design and is consistent across all tenants and across commercial and US Government clouds.
 Step 3: Review and verify Copilot and other AI data to delete in eDiscovery
 The deletion process in Step 5 deletes the items returned by the search. Review the search results to ensure that the search only returns the items that you want to delete.
 You can use the search statistics (specifically the

```

---

### 11. Create communication compliance policies
...
### 13. Copilot extensibility overview
...
### 14. Build agents with Agent Builder
...
### 15. Connect an existing MCP server to an agent
...
### 17. Microsoft Agent 365 overview
...
### 18. Agent management in Microsoft 365 admin center
...
### 19. Agent registry in Microsoft 365 admin center
...
### 20. Conditional Access for agent identities
...
### 21. Identity Protection for agents
...
### 23. Zero Trust deployment guide
