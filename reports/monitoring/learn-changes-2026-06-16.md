...
**Run Date:** 2026-06-16
**Run Time:** 2026-06-16T14:51:59.777936+00:00
...
| 11 | cowork-admin-governance | MEDIUM | None | Review optional |
| 12 | overview-copilot-connector | MEDIUM | 2.13 | Review optional |
| 13 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 14 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 15 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 16 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 17 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 18 | content-governance-agent | HIGH | 1.7 | Review and update |
| 19 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 20 | archive-overview | HIGH | 3.2 | Review and update |
...
### 11. Conditional Access for agent identities
...
### 12. Get ready for Copilot with SharePoint Advanced Management
...
### 14. SharePoint Admin Agent (Content Governance Agent)
...
### 15. Microsoft Defender for Cloud Apps
...
### 16. Microsoft 365 Archive overview
