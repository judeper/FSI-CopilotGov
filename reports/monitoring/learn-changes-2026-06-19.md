...
**Run Date:** 2026-06-19
**Run Time:** 2026-06-19T13:27:43.760355+00:00
...
| 8 | apply-sensitivity-label-automatically | HIGH | 1.5, 2.2 | Review and update |
| 9 | audit-log-activities | CRITICAL | 1.15 | Monitor |
| 10 | create-retention-policies | HIGH | 3.2 | Review and update |
| 11 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 12 | purview-management | HIGH | None | Review and update |
| 13 | ...m/en-us/microsoft-365/copilot/cowork/ | HIGH | None | Review and update |
| 14 | get-started | HIGH | None | Review and update |
| 15 | cowork-admin-governance | HIGH | None | Review and update |
| 16 | cowork-manage-plugins | HIGH | None | Review and update |
| 17 | cowork-faq | HIGH | None | Review and update |
| 18 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, 2.1, index | Review optional |
| 19 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.14, 2.16, 2.13 | Review and update |
| 20 | overview-copilot-connector | MEDIUM | 2.13 | Review optional |
| 21 | authoring-ask-a-question | HIGH | None | Review and update |
| 22 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 23 | agent-registry | MEDIUM | 4.13, 2.14 | Review optional |
| 24 | ...n.microsoft.com/en-us/entra/agent-id/ | MEDIUM | 2.17 | Review optional |
| 25 | what-is-microsoft-entra-agent-id | MEDIUM | None | Review optional |
| 26 | what-are-agent-identities | MEDIUM | None | Review optional |
| 27 | whats-new-agent-id | MEDIUM | None | Review optional |
| 28 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 29 | configure-third-party-agents | MEDIUM | None | Review optional |
| 30 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 31 | concept-risky-agents | HIGH | None | Review and update |
...
| 34 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 35 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 36 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 37 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 38 | content-governance-agent | HIGH | 1.7 | Review and update |
| 39 | zero-trust-microsoft-365-copilot | HIGH | None | Review and update |
| 40 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 41 | archive-overview | HIGH | 3.2 | Review and update |
...
### 7. Copilot Pages and Notebooks compliance summary
...
### 8. Purview management for SharePoint Embedded containers
...
### 10. Get started with Copilot Cowork
...
### 11. Copilot Cowork admin and governance
...
### 12. Manage Copilot Cowork plugins
...
### 15. Adaptive cards in Copilot Studio topics
...
### 16. Agent management in Microsoft 365 admin center
...
### 17. Conditional Access for agent identities
...
### 18. Identity Protection for agents
...
### 21. Restricted Content Discovery
...
### 8. Microsoft Entra Agent ID documentation
