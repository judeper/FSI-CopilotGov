...
**Run Date:** 2026-05-20
**Run Time:** 2026-05-20T12:15:55.300447+00:00
...
| 6 | whats-new | CRITICAL | None | Monitor |
| 7 | ai-m365-copilot | HIGH | None | Review and update |
| 8 | endpoint-dlp-learn-about | HIGH | None | Review and update |
| 9 | audit-solutions-overview | HIGH | 3.1 | Review and update |
| 10 | audit-search | HIGH | 3.1 | Review and update |
| 11 | audit-log-activities | HIGH | 1.15 | Review and update |
| 12 | cpcn-admin-configuration | HIGH | 2.11 | Review and update |
| 13 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 14 | cpcn-loop-purview-management | HIGH | None | Review and update |
| 15 | cowork-admin-governance | HIGH | None | Review and update |
| 16 | concept-conditional-access-policy-common | MEDIUM | None | Review optional |
| 17 | ai-microsoft-purview | HIGH | 1.1, 1.2 | Review and update |
| 18 | .../microsoft-365/copilot/extensibility/ | HIGH | 2.14, 1.13 | Review and update |
| 19 | manage-copilot-agents-integrated-apps | HIGH | 2.13, 2.14, 1.13, 4.1, 4.13 | Review and update |
| 20 | overview-copilot-connector | HIGH | None | Review and update |
| 21 | overview-declarative-agent | HIGH | 2.14, 1.13 | Review and update |
| 22 | ...t.com/en-us/microsoft-copilot-studio/ | HIGH | 4.14 | Review and update |
| 23 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 24 | agent-365-overview | HIGH | 4.5, 4.13 | Review and update |
| 25 | agent-registry | HIGH | 2.14, 4.13 | Review and update |
| 26 | agent-settings | HIGH | 2.13, 2.14, 4.13 | Review and update |
| 27 | agent-registry | MEDIUM | None | Review optional |
| 28 | agents-are-apps | HIGH | None | Review and update |
| 29 | data-privacy-security | MEDIUM | None | Review optional |
| 30 | what-is-microsoft-entra-agent-id | MEDIUM | 2.17 | Review optional |
| 31 | what-are-agent-identities | MEDIUM | None | Review optional |
| 32 | whats-new-agent-id | MEDIUM | None | Review optional |
| 33 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 34 | agent-id | HIGH | 2.17 | Review and update |
| 35 | concept-risky-agents | MEDIUM | None | Review optional |
| 36 | agent-id-governance-overview | MEDIUM | None | Review optional |
| 37 | concept-secure-web-ai-gateway-agents | MEDIUM | None | Review optional |
| 38 | advanced-management | HIGH | 1.7 | Review and update |
| 39 | data-access-governance-reports | HIGH | 1.1, 1.7, 1.15, 1.14 | Review and update |
| 40 | insights-on-sharepoint-agents | HIGH | None | Review and update |
| 41 | content-management-assessment | HIGH | 1.7 | Review and update |
| 42 | site-lifecycle-management | HIGH | 1.7 | Review and update |
| 43 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 44 | content-governance-agent | HIGH | 1.7 | Review and update |
...
### 4. Use Purview for Copilot data security
...
### 6. Microsoft Purview Audit overview
...
### 9. Manage Copilot Pages and Notebooks
...
### 10. Copilot Pages and Notebooks compliance summary
...
### 11. Purview management for SharePoint Embedded containers
...
+Although compliance admins define a sensitivity label's priority, a higher priority number usually denotes higher sensitivity of the content, with more restrictive permissions. As a result, Cowork responses display the most restrictive sensitivity label to educate the user about the sensitivity of the data.
 Data residency
 By default, Cowork stores conversation content in your tenant's local region geography. It also supports Advanced Data Residency (ADR) and Multi-Geo configurations. Learn more in
 Data residency for Microsoft 365 Copilot
@@ -194,6 +190,7 @@ Deploy agents in Micro
```

---

### 13. DSPM for AI (classic) overview
...
### 14. Copilot extensibility overview
...
### 16. Microsoft Graph connectors overview
...
### 17. Declarative agents for Copilot
...
### 18. Microsoft Copilot Studio documentation
...
### 19. Connect an existing MCP server to an agent
...
### 20. Agent management in Microsoft 365 admin center
...
### 21. Agent registry in Microsoft 365 admin center
...
### 22. Agent settings in Microsoft 365 admin center
...
### 23. Microsoft 365 Copilot agent governance
...
### 24. Conditional Access for agent identities
...
### 25. SharePoint Advanced Management
...
### 27. Agent insights report in SharePoint
...
### 28. SAM Content Management Assessment
...
### 29. SharePoint site lifecycle management
...
### 30. Restricted Content Discovery
...
### 31. SharePoint Admin Agent (Content Governance Agent)
