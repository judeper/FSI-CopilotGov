...
**Run Date:** 2026-06-25
**Run Time:** 2026-06-25T12:12:03.998783+00:00
...
| 10 | apply-sensitivity-label-automatically | HIGH | 1.5, 2.2 | Review and update |
| 11 | audit-search | HIGH | 3.14, 3.1 | Review and update |
| 12 | audit-log-activities | CRITICAL | 1.15 | Monitor |
| 13 | audit-log-retention-policies | HIGH | 3.1 | Review and update |
| 14 | create-retention-policies | HIGH | 3.2 | Review and update |
| 15 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 16 | purview-management | HIGH | None | Review and update |
| 17 | ...m/en-us/microsoft-365/copilot/cowork/ | HIGH | None | Review and update |
| 18 | get-started | HIGH | None | Review and update |
| 19 | cowork-admin-governance | HIGH | None | Review and update |
| 20 | cowork-manage-plugins | HIGH | None | Review and update |
| 21 | cowork-faq | HIGH | None | Review and update |
| 22 | communication-compliance-policies | HIGH | 3.4, 3.5 | Review and update |
| 23 | ...tion-compliance-investigate-remediate | HIGH | None | Review and update |
| 24 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, 2.1, index | Review optional |
| 25 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.14, 2.16, 2.13 | Review and update |
| 26 | overview-copilot-connector | MEDIUM | 2.13 | Review optional |
| 27 | authoring-ask-a-question | HIGH | None | Review and update |
| 28 | authoring-select-agent-model | MEDIUM | 4.14, 1.16 | Review optional |
| 29 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 30 | agent-registry | MEDIUM | 4.13, 2.14 | Review optional |
| 31 | ...n.microsoft.com/en-us/entra/agent-id/ | HIGH | 2.17 | Review and update |
| 32 | what-is-microsoft-entra-agent-id | MEDIUM | None | Review optional |
| 33 | what-are-agent-identities | MEDIUM | None | Review optional |
| 34 | whats-new-agent-id | MEDIUM | None | Review optional |
| 35 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 36 | configure-third-party-agents | MEDIUM | None | Review optional |
| 37 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 38 | concept-risky-agents | HIGH | None | Review and update |
| 39 | agent-id-governance-overview | HIGH | None | Review and update |
| 40 | concept-secure-web-ai-gateway-agents | MEDIUM | None | Review optional |
| 41 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 42 | create-analytics-rules | HIGH | None | Review and update |
| 43 | monitor-your-data | HIGH | 4.11 | Review and update |
| 44 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 45 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 46 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 47 | content-governance-agent | HIGH | 1.7 | Review and update |
| 48 | zero-trust-microsoft-365-copilot | HIGH | None | Review and update |
| 49 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 50 | archive-overview | HIGH | 3.2 | Review and update |
...
### 7. Apply sensitivity labels automatically
...
### 9. Manage audit log retention policies
...
### 10. Create and configure retention policies
...
### 14. Get started with Copilot Cowork
...
### 15. Copilot Cowork admin and governance
...
### 16. Manage Copilot Cowork plugins
...
### 18. Create communication compliance policies
...
### 19. Investigate and remediate alerts
...
### 20. Copilot extensibility overview
...
### 21. Adaptive cards in Copilot Studio topics
...
### 22. Agent management in Microsoft 365 admin center
...
### 23. Microsoft Entra Agent ID documentation
...
### 25. Identity Protection for agents
...
### 26. Microsoft Entra ID Governance for agent identities
...
### 29. Get ready for Copilot with SharePoint Advanced Management
...
### 31. Restricted Content Discovery
...
**What Changed:**
```diff
--- +++ @@ -22,106 +22,162 @@ Restrict discovery of SharePoint sites and content
 Feedback
 Summarize this article for me
...
### 32. SharePoint Admin Agent (Content Governance Agent)
...
### 33. Zero Trust for Microsoft 365 Copilot
...
### 34. Microsoft Defender for Cloud Apps
...
### 35. Microsoft 365 Archive overview
