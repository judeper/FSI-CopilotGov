...
**Run Date:** 2026-06-24
**Run Time:** 2026-06-24T12:13:44.700404+00:00
...
| 11 | audit-log-activities | CRITICAL | 1.15 | Monitor |
| 12 | create-retention-policies | HIGH | 3.2 | Review and update |
| 13 | cpcn-compliance-summary | HIGH | 2.11 | Review and update |
| 14 | purview-management | HIGH | None | Review and update |
| 15 | ...m/en-us/microsoft-365/copilot/cowork/ | HIGH | None | Review and update |
| 16 | get-started | HIGH | None | Review and update |
| 17 | cowork-admin-governance | HIGH | None | Review and update |
| 18 | cowork-manage-plugins | HIGH | None | Review and update |
| 19 | cowork-faq | HIGH | None | Review and update |
| 20 | communication-compliance-policies | HIGH | 3.4, 3.5 | Review and update |
| 21 | ...tion-compliance-investigate-remediate | HIGH | None | Review and update |
| 22 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, 2.1, index | Review optional |
| 23 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.14, 2.16, 2.13 | Review and update |
| 24 | overview-copilot-connector | MEDIUM | 2.13 | Review optional |
| 25 | authoring-ask-a-question | HIGH | None | Review and update |
| 26 | authoring-select-agent-model | MEDIUM | 4.14, 1.16 | Review optional |
| 27 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 28 | agent-registry | MEDIUM | 4.13, 2.14 | Review optional |
| 29 | ...n.microsoft.com/en-us/entra/agent-id/ | HIGH | 2.17 | Review and update |
| 30 | what-is-microsoft-entra-agent-id | MEDIUM | None | Review optional |
...
| 34 | configure-third-party-agents | MEDIUM | None | Review optional |
| 35 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 36 | concept-risky-agents | HIGH | None | Review and update |
| 37 | agent-id-governance-overview | HIGH | None | Review and update |
| 38 | concept-secure-web-ai-gateway-agents | MEDIUM | None | Review optional |
| 39 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 40 | create-analytics-rules | HIGH | None | Review and update |
| 41 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 42 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 43 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 44 | content-governance-agent | HIGH | 1.7 | Review and update |
| 45 | zero-trust-microsoft-365-copilot | HIGH | None | Review and update |
| 46 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 47 | archive-overview | HIGH | 3.2 | Review and update |
...
### 9. Copilot Pages and Notebooks compliance summary
...
### 10. Purview management for SharePoint Embedded containers
...
### 12. Get started with Copilot Cowork
...
### 14. Manage Copilot Cowork plugins
...
### 16. Create communication compliance policies
...
### 17. Investigate and remediate alerts
...
### 18. Copilot extensibility overview
...
### 19. Adaptive cards in Copilot Studio topics
...
### 21. Microsoft Entra Agent ID documentation
...
### 22. Conditional Access for agent identities
...
### 23. Identity Protection for agents
...
### 24. Microsoft Entra ID Governance for agent identities
...
### 26. Get ready for Copilot with SharePoint Advanced Management
...
### 28. Restricted Content Discovery
...
### 29. SharePoint Admin Agent (Content Governance Agent)
...
### 30. Zero Trust for Microsoft 365 Copilot
...
### 31. Microsoft Defender for Cloud Apps
...
### 32. Microsoft 365 Archive overview
