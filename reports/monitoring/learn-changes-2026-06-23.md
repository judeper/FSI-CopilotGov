...
**Run Date:** 2026-06-23
**Run Time:** 2026-06-23T12:28:03.190716+00:00
...
| 26 | agent-365-overview | HIGH | 4.13, 4.5 | Review and update |
| 27 | agent-registry | MEDIUM | 4.13, 2.14 | Review optional |
| 28 | ...n.microsoft.com/en-us/entra/agent-id/ | HIGH | 2.17 | Review and update |
| 29 | what-is-microsoft-entra-agent-id | MEDIUM | None | Review optional |
| 30 | what-are-agent-identities | MEDIUM | None | Review optional |
| 31 | whats-new-agent-id | MEDIUM | None | Review optional |
| 32 | what-is-agent-id-platform | MEDIUM | None | Review optional |
| 33 | configure-third-party-agents | MEDIUM | None | Review optional |
| 34 | agent-id | HIGH | 2.3, 2.17 | Review and update |
| 35 | concept-risky-agents | HIGH | None | Review and update |
...
| 38 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 39 | create-analytics-rules | HIGH | None | Review and update |
| 40 | ...opilot-sharepoint-advanced-management | HIGH | 1.13, 1.3 | Review and update |
| 41 | ai-in-sharepoint-get-started | HIGH | None | Review and update |
| 42 | restricted-content-discovery | HIGH | 1.7 | Review and update |
| 43 | content-governance-agent | HIGH | 1.7 | Review and update |
| 44 | zero-trust-microsoft-365-copilot | HIGH | None | Review and update |
| 45 | what-is-defender-for-cloud-apps | HIGH | 2.9 | Review and update |
| 46 | archive-overview | HIGH | 3.2 | Review and update |
...
### 25. Get ready for Copilot with SharePoint Advanced Management
...
### 27. Restricted Content Discovery
...
### 28. SharePoint Admin Agent (Content Governance Agent)
...
### 29. Zero Trust for Microsoft 365 Copilot
...
### 30. Microsoft Defender for Cloud Apps
...
### 31. Microsoft 365 Archive overview
