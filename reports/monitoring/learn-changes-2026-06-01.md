...
**Run Date:** 2026-06-01
**Run Time:** 2026-06-01T15:48:13.374259+00:00
...
| 11 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.13, 2.17, 2.16, 2.14 | Review and update |
| 12 | agent-builder-build-agents | HIGH | None | Review and update |
| 13 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 14 | authoring-select-agent-model | HIGH | None | Review and update |
| 15 | agent-365-overview | HIGH | 4.5, 4.13 | Review and update |
| 16 | agent-registry | HIGH | 4.13, 2.14 | Review and update |
| 17 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 18 | content-governance-agent | HIGH | 1.7 | Review and update |
| 19 | overview | HIGH | None | Review and update |
...
### 9. Build agents with Agent Builder
...
### 10. Connect an existing MCP server to an agent
...
### 12. Agent management in Microsoft 365 admin center
...
### 13. Agent registry in Microsoft 365 admin center
...
### 15. Zero Trust deployment guide
