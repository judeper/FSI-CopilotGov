...
**Run Date:** 2026-06-03
**Run Time:** 2026-06-03T14:21:34.416067+00:00
...
| 3 | whats-new | HIGH | 4.12 | Review and update |
| 4 | dlp-policy-reference | HIGH | None | Review and update |
| 5 | create-sensitivity-labels | HIGH | None | Review and update |
| 6 | sensitivity-labels-office-apps | HIGH | None | Review and update |
| 7 | audit-log-activities | CRITICAL | 1.15 | Monitor |
| 8 | retention-policies-teams | HIGH | 4.2 | Review and update |
| 9 | cowork-faq | MEDIUM | None | Review optional |
| 10 | plan-conditional-access | HIGH | 2.3 | Review and update |
| 11 | information-barriers-teams | HIGH | 2.4 | Review and update |
| 12 | communication-compliance-policies | CRITICAL | 3.5, 3.4 | Review and update |
| 13 | ai-microsoft-purview | MEDIUM | 1.2, 1.1, index, 2.1 | Review optional |
| 14 | ...curity-posture-management-learn-about | HIGH | 1.14, 3.10 | Review and update |
| 15 | .../microsoft-365/copilot/extensibility/ | HIGH | 4.13, 1.13, 2.13, 2.17, 2.16, 2.14 | Review and update |
| 16 | agent-builder-build-agents | HIGH | None | Review and update |
| 17 | mcp-add-existing-server-to-agent | HIGH | None | Review and update |
| 18 | authoring-select-agent-model | HIGH | None | Review and update |
| 19 | overview | MEDIUM | None | Review optional |
| 20 | agent-365-overview | HIGH | 4.5, 4.13 | Review and update |
| 21 | agent-registry | HIGH | 4.13, 2.14 | Review and update |
| 22 | agent-id | HIGH | 2.17 | Review and update |
| 23 | concept-risky-agents | HIGH | None | Review and update |
| 24 | data-connectors-reference | CRITICAL | 4.11, 3.1 | Monitor |
| 25 | content-governance-agent | HIGH | 1.7 | Review and update |
| 26 | overview | HIGH | None | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -19,82 +19,51 @@ Access to this page requires authorization. You can try
 changing directories
 .
...
### 19. SharePoint Admin Agent (Content Governance Agent)
...
### 20. Zero Trust deployment guide
