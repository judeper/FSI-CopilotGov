...
- **MkDocs Material documentation site** in `docs/` (framework, 63 controls across 4 pillars, playbooks, reference).
- **Python assessment engine** (`assessment/engine/`) — scores collector evidence against the 63-control manifest and emits reports.
...
- **Controls** (`docs/controls/pillar-{1-4}-*/`) — 63 technical controls across 4 lifecycle pillars specifying *what* to configure and *why*.
